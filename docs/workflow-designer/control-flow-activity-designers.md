---
title: Designer de fluxo de trabalho - Designers de atividade de fluxo de controle
ms.date: 11/04/2016
ms.topic: reference
...
ms.locfileid: "31967394"
---
# <a name="control-flow-activity-designers"></a>Designer de atividade de fluxo de controle

Designer de fluxo de trabalho do Windows inclui um número de atividades fornecido pelo sistema que você pode usar ao construir os fluxos de trabalho. Esta seção contém sistema forneceu as atividades usadas para controlar o fluxo em um fluxo de trabalho. Os tópicos a seguir descrevem essas atividades e fornecem orientação sobre como usá-los.
