...
Os designers de atividade de migração são usados para chamar 3.0/3.5 atividades de fluxo de trabalho de um fluxo de trabalho direcionando o .NET Framework 4. Os tópicos contidos nesta seção fornecem orientação sobre como usar os designers de atividade do Designer de fluxo de trabalho.
