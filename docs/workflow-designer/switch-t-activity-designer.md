...
ms.locfileid: "31978278"
---
# <a name="switcht-activity-designer"></a>Opção\<T > Designer de atividade
...
O **Switch < T\>**  designer de atividade é usado para criar e configurar um <xref:System.Activities.Statements.Switch%601> atividade no Designer de fluxo de trabalho do Windows.
