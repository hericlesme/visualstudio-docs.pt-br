...
-   [A instalação e as tarefas gerais de](#projects).  
...
### <a name="task-panes-in-document-level-customizations"></a>Painéis de tarefas em personalizações no nível do documento  
