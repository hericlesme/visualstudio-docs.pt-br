...
-   O [Central de desenvolvedores do Microsoft Office](http://go.microsoft.com/fwlink/?LinkId=83467) contém links para artigos técnicos, exemplos de código, downloads, informações da comunidade, suporte e outras documentações sobre personalizações do Office e aplicativos de negócios do Office (OBAs ).  
...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Fornece informações sobre como automatizar o Microsoft Office project e criar o projeto de suplementos do VSTO.  
...
## <a name="related-sections"></a>Seções relacionadas  
 ...
 A área da biblioteca do MSDN, onde você pode encontrar artigos e documentação de referência sobre desenvolvimento de soluções para várias versões do Office (não específica ao desenvolvimento do Office usando o Visual Studio).  
  
 [Desenvolvimento de aplicativo no Visual Studio](http://msdn.microsoft.com/en-us/97490c1b-a247-41fb-8f2c-bc4c201eff68)  
 Contém links para tópicos que explicam como você pode usar o Visual Studio para projetar, desenvolver, depurar e implantar aplicativos da web, os XML web services e aplicativos cliente tradicionais.  
