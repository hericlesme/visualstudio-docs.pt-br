---
title: "Como: executar ações programaticamente quando é recebida uma mensagem de email | Microsoft Docs"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
---
# <a name="how-to-programmatically-perform-actions-when-an-e-mail-message-is-received"></a>Como executar ações programaticamente quando uma mensagem de email é recebida
