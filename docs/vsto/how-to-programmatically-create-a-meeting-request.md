---
title: "Como: criar programaticamente uma solicitação de reunião | Microsoft Docs"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
---
# <a name="how-to-programmatically-create-a-meeting-request"></a>Como criar uma solicitação de reunião programaticamente
