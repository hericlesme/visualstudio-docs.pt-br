...
## <a name="document-vs-template-solutions"></a>Versus soluções de modelo de documento  
...
##  <a name="Limitations"></a> Limitações de modelos globais e do Excel em suplementos (arquivos. xla)  
