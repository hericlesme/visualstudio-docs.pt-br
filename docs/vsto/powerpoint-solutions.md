...
##  <a name="WordOMDocumentation"></a> Use a documentação do modelo de objeto do PowerPoint  
...
### <a name="primary-interop-assembly-reference"></a>Referência de assembly de interoperabilidade primária  
 A documentação de referência do PowerPoint PIA descreve os tipos no assembly de interoperabilidade primário para o PowerPoint. Esta documentação está disponível no seguinte local: [referência de assembly de interoperabilidade primária do PowerPoint 2010](http://go.microsoft.com/fwlink/?LinkId=189588).  
