...
## <a name="deployment-topics"></a>Tópicos de implantação  
 ...
 Fornece informações sobre como usar o **Assistente de publicação** ou **publicar** página do Designer de projeto para publicar as soluções do Office.  
 ...
 Fornece etapas para instalar soluções do Office, executando o programa de instalação que é gerado durante o processo de publicação; abrir o arquivo de manifesto de implantação; ou a abertura de um documento personalizado ou uma pasta de trabalho.  
  
 [Como: instalar pré-requisitos em computadores de usuário final para executar soluções do Office](http://msdn.microsoft.com/en-us/74dd2c52-838f-4abf-b2b4-4d7b0c2a0a98)  
