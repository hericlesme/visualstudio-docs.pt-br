...
-   [Usando recursos de vários aplicativos do Microsoft Office em um único projeto](#usingfeatures)  
...
### <a name="primary-interop-assemblies-in-the-program-files-directory"></a>Assemblies de interoperabilidade primários no diretório de arquivos de programas  
