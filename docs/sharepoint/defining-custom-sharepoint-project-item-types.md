...
## <a name="understand-the-relationship-between-project-item-types-and-project-item-instances"></a>Compreender a relação entre os tipos de item de projeto e instâncias de item de projeto
