...
Na web part, especificar calendários que você deseja incluir na exibição de calendário mensal e, em seguida, escolha o **atualização** botão.
...
[Como criar um Web Part para o SharePoint](../sharepoint/how-to-create-a-sharepoint-web-part.md)  
[Como criar um Web Part do SharePoint usando um designer](../sharepoint/how-to-create-a-sharepoint-web-part-by-using-a-designer.md)  
