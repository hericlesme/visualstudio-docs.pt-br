...
## <a name="add-filter-descriptors"></a>Adicionar descritores de filtros
...
## <a name="validate-the-model"></a>Valide o modelo
...
## <a name="debug-the-solution-that-contains-the-model"></a>A solução que contém o modelo de depuração
...
### <a name="retract-models-that-become-corrupt"></a>Cancele a modelos que estão corrompidos
...
## <a name="locate-documentation-for-bdc-model-elements"></a>Localize a documentação para os elementos de modelo BDC
