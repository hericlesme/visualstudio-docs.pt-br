...
## [Pré-requisitos de implantação do aplicativo](application-deployment-prerequisites.md)
### [Implantar pré-requisitos para aplicativos de 64 bits](deploying-prerequisites-for-64-bit-applications.md)
### [Criar pacotes de bootstrapper](creating-bootstrapper-packages.md)
...
### [Passo a passo: criando um bootstrapper personalizado com um prompt de privacidade](walkthrough-creating-a-custom-bootstrapper-to-show-a-privacy-prompt.md)
