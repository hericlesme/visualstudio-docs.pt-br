...
Quando você tiver definido uma DSL, você pode distribuí-lo a outros usuários podem instalá-lo em seus próprios computadores. Os usuários de seu DSL podem criar e editar modelos no Visual Studio.  
