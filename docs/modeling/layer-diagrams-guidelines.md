...
2.  [Definir camadas para representar as áreas funcionais principais ou componentes](#CreateLayers) do seu aplicativo. Nomeie dessas camadas de acordo com sua função, por exemplo, "Apresentação" ou "Serviços". Se você tiver um [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] solução, você pode associar cada camada com uma coleção de *artefatos*, como namespaces, projetos, arquivos e assim por diante.
