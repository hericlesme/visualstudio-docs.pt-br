...
ms.locfileid: "39511805"
---
# <a name="customize-file-storage-and-xml-serialization"></a>Personalizar o armazenamento de arquivos e a serialização XML

Quando o usuário salva uma instância, ou *modelo*, de uma linguagem específica de domínio (DSL) em [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)], um arquivo XML é criado ou atualizado. O arquivo pode ser recarregado para recriar o modelo na Store.
