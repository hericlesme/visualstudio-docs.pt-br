...
ms.locfileid: "31954146"
---
# <a name="customize-file-storage-and-xml-serialization"></a>Personalizar a serialização de XML e armazenamento de arquivos
...
## <a name="understand-monikers"></a>Entender os identificadores de origem
...
### <a name="avoid-duplicate-monikers"></a>Evitar identificadores duplicados
