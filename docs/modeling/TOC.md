...
## [Alterar o design usando ferramentas de visualização e modelagem](scenario-change-your-design-using-visualization-and-modeling.md)
## [Visualizar código](visualize-code.md)
### [Usar mapas de códigos para mapear as dependências](map-dependencies-across-your-solutions.md)
### [Compartilhar mapas de códigos](share-code-maps.md)
### [Mapas de códigos para C++](code-maps-for-cpp.md)
### [Desempenho de mapa de códigos](code-maps-performance.md)
...
### [Personalizar mapas de códigos](customize-code-maps-by-editing-the-dgml-files.md)
...
### [Compartilhar modelos e diagramas de exportação](share-models-and-exporting-diagrams.md)
...
### [Entender os modelos, as classes e as relações](understanding-models-classes-and-relationships.md)
### [Como definir uma linguagem específica de domínio](how-to-define-a-domain-specific-language.md)
### [Personalizar e estender uma linguagem específica de domínio](customizing-and-extending-a-domain-specific-language.md)
#### [Personalizar a apresentação no diagrama](customizing-presentation-on-the-diagram.md)
##### [Definir formas e conectores](defining-shapes-and-connectors.md)
##### [Controlar cor, estilo de linha e outras propriedades de forma](controlling-color-line-style-and-other-shape-properties.md)
##### [Controlar a visibilidade de um ícone ou decorador](controlling-the-visibility-of-an-icon-or-decorator.md)
##### [Personalizar campos de texto e imagem](customizing-text-and-image-fields.md)
##### [Configurar uma imagem de tela de fundo em um diagrama](setting-a-background-image-on-a-diagram.md)
##### [Aninhar formas](nesting-shapes.md)
##### [Inserir um diagrama em um formulário do Windows](embedding-a-diagram-in-a-windows-form.md)
#### [Personalizar ferramentas e a caixa de ferramentas](customizing-tools-and-the-toolbox.md)
#### [Personalizar a criação e o movimento de elementos](customizing-element-creation-and-movement.md)
#### [Personalizar o comportamento de cópia](customizing-copy-behavior.md)
#### [Personalizar o comportamento de exclusão](customizing-deletion-behavior.md)
#### [Personalizar a janela Propriedades](customizing-the-properties-window.md)
#### [Personalizar o Explorador de Modelos](customizing-the-model-explorer.md)
...
#### [Compartilhar classes entre DSLs por meio de uma biblioteca de DSLs](sharing-classes-between-dsls-by-using-a-dsl-library.md)
### [Gravar código para personalizar uma linguagem específica de domínio](writing-code-to-customise-a-domain-specific-language.md)
#### [Substituir e estender as classes geradas](overriding-and-extending-the-generated-classes.md)
#### [Navegar e atualizar um modelo no código do programa](navigating-and-updating-a-model-in-program-code.md)
#### [Como usar transações para atualizar o modelo](how-to-use-transactions-to-update-the-model.md)
#### [Integrar modelos por meio do Visual Studio ModelBus](integrating-models-by-using-visual-studio-modelbus.md)
...
#### [Definir uma política de bloqueio para criar segmentos somente leitura](defining-a-locking-policy-to-create-read-only-segments.md)
#### [Adicionar extensões a definições de DSL](adding-extensions-to-dsl-definitions.md)
#### [Adicionar uma propriedade de acompanhamento a uma definição de linguagem específica de domínio](adding-a-tracking-property-to-a-domain-specific-language-definition.md)
#### [Depurar por meio do Visualizador de Repositório](debugging-by-using-the-store-viewer.md)
#### [O arquivo DslDefinition.dsl](the-dsldefinition-dsl-file.md)
#### [Entender o código DSL](understanding-the-dsl-code.md)
### [Validação em uma linguagem específica de domínio](validation-in-a-domain-specific-language.md)
### [Gravar ações e comandos de usuário](writing-user-commands-and-actions.md)
...
#### [Personalizar ferramentas de elemento](customizing-element-tools.md)
### [Responder e propagar alterações](responding-to-and-propagating-changes.md)
...
#### [Atualizar formas e conectores para refletir o modelo](updating-shapes-and-connectors-to-reflect-the-model.md)
### [Gerar código com base em uma linguagem específica de domínio](generating-code-from-a-domain-specific-language.md)
#### [Acessar modelos por meio de modelos de texto](accessing-models-from-text-templates.md)
#### [Usar o Visual Studio ModelBus em um modelo de texto](using-visual-studio-modelbus-in-a-text-template.md)
#### [Explicação passo a passo: depurar um modelo de texto que acessa um modelo](walkthrough-debugging-a-text-template-that-accesses-a-model.md)
#### [Explicação passo a passo: conectar um host a um processador de diretriz gerado](walkthrough-connecting-a-host-to-a-generated-directive-processor.md)
#### [O comando DslTextTransform](the-dsltexttransform-command.md)
### [Personalizar o armazenamento de arquivos e a serialização XML](customizing-file-storage-and-xml-serialization.md)
### [Implantar soluções de linguagem específica de domínio](deploying-domain-specific-language-solutions.md)
...
### [Criar uma linguagem específica de domínio baseada no Windows Forms](creating-a-windows-forms-based-domain-specific-language.md)
### [Criar uma linguagem específica de domínio baseada no WPF](creating-a-wpf-based-domain-specific-language.md)
### [Trabalhar com soluções de linguagem específica de domínio](working-with-domain-specific-language-solutions.md)
...
#### [Escolher um modelo de solução de linguagem específica de domínio](choosing-a-domain-specific-language-solution-template.md)
#### [Como criar uma solução de linguagem específica de domínio](how-to-create-a-domain-specific-language-solution.md)
#### [Trabalhar com o diagrama de definição de DSL](working-with-the-dsl-definition-diagram.md)
#### [Trabalhar com o Explorador de Linguagem Específica de Domínio](working-with-the-domain-specific-language-explorer.md)
...
#### [Explicação passo a passo: gerenciar código usando modelos de texto](walkthrough-generating-code-by-using-text-templates.md)
...
#### [Gerar arquivos com o utilitário TextTransform](generating-files-with-the-texttransform-utility.md)
### [Geração de texto de tempo de execução com modelos de texto T4](run-time-text-generation-with-t4-text-templates.md)
### [Gravar um modelo de texto T4](writing-a-t4-text-template.md)
...
#### [Acessar o Visual Studio ou outros hosts por meio de um modelo de texto](accessing-visual-studio-or-other-hosts-from-a-text-template.md)
#### [Usar sequências de escape em modelos de texto](using-escape-sequences-in-text-templates.md)
...
### [Depurar um modelo de texto T4](debugging-a-t4-text-template.md)
...
### [Personalizar a transformação de texto T4](customizing-t4-text-transformation.md)
#### [O processo de transformação de modelo de texto](the-text-template-transformation-process.md)
#### [Criar processadores de diretiva de modelo de texto T4 personalizados](creating-custom-t4-text-template-directive-processors.md)
##### [Implantar um processador de diretiva personalizado](deploying-a-custom-directive-processor.md)
##### [Explicação passo a passo: criar um processador de diretiva personalizado](walkthrough-creating-a-custom-directive-processor.md)
#### [Invocar transformação de texto em uma extensão do VS](invoking-text-transformation-in-a-vs-extension.md)
#### [Processar modelos de texto usando um host personalizado](processing-text-templates-by-using-a-custom-host.md)
##### [Explicação passo a passo: criar um host de modelo de texto personalizado](walkthrough-creating-a-custom-text-template-host.md)
