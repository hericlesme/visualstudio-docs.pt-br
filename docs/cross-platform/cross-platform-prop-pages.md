...
---
# <a name="c-cross-platform-property-page-reference"></a>Referência da página de propriedades multiplataforma C++

Esta seção contém informações sobre as propriedades de projetos multiplataforma C++.

- [Propriedades gerais do projeto (Android C++)](general-android-prop-page.md)
