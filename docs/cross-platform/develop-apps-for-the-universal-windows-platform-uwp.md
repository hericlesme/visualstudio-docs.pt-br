...
-   [Windows 10](http://windows.microsoft.com/windows/downloads). O Visual Studio 2017 dá suporte ao desenvolvimento de UWP somente no Windows 10. Para obter mais detalhes, consulte [Direcionamento para Plataformas](https://www.visualstudio.com/productinfo/vs2017-compatibility-vs) e [Requisitos de Sistema](https://www.visualstudio.com/en-us/productinfo/vs2017-system-requirements-vs) do Visual Studio.   
  
-   [Visual Studio](https://www.visualstudio.com/downloads/). Você também precisará da carga de trabalho de desenvolvimento da Plataforma Universal do Windows opcional.  
