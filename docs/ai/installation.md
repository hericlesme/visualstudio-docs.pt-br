...
Saiba mais sobre a instalação do [Python para Ferramentas do Visual Studio](https://docs.microsoft.com/visualstudio/python/installation) para obter mais detalhes.
