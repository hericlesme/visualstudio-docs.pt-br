---
title: Trabalhando com o Python no Visual Studio, etapa 4 | Microsoft Docs
ms.custom: 
ms.date: 09/26/2017
ms.reviewer: 
ms.suite: 
...
**Etapa anterior: [usando a janela interativa REPL](vs-tutorial-01-03.md)**
...
1. Verifique se o código funciona corretamente pressionando F5 ou selecionando o comando de menu **Depurar > Iniciar Depuração**. Esse comando executa o código no depurador, mas como você não fez nada para pausar o programa enquanto ele está em execução, ele apenas imprime um padrão de onda para algumas iterações. Pressione uma tecla para exibir janela de saída.
...
> [Instalando pacotes no ambiente do Python](vs-tutorial-01-05.md)

### <a name="going-deeper"></a>Aprofundando-se
- [Depuração](debugging.md).
- [Depuração no Visual Studio](../debugger/debugging-in-visual-studio.md) oferece uma documentação completa sobre os recursos de depuração do Visual Studio.
