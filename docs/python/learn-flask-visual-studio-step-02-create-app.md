...
1. Na pasta `HelloFlask`, crie um arquivo chamado `__init__.py` com o seguinte conteúdo que cria a instância `Flask` e carrega as exibições do aplicativo (criadas na próxima etapa):
