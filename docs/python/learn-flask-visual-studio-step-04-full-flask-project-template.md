...
ms.locfileid: "34752122"
---
# <a name="tutorial-step-4-use-the-full-flask-web-project-template"></a>Etapa 4 do Tutorial: Usar o modelo Projeto Web completo do Flask
...
Ao abrir um dos arquivos `.jade`, é possível ver a expressão mais sucinta de um modelo. Por exemplo, veja o conteúdo de `templates/layout.jade` conforme criado pelo modelo "Projeto Web do Flask/Jade":
...
- Código-fonte do tutorial no GitHub: [Microsoft/python-sample-vs-learn-flask](https://github.com/Microsoft/python-sample-vs-learn-flask)