...
# [Criando sua primeira extensão: Olá, Mundo](extensibility-hello-world.md)
...
# [Com escrever extensões de ida e volta para o Visual Studio](how-to-roundtrip-VSIXs.md)
# [Protocolo de Idioma do Servidor](language-server-protocol.md)
##[Adicionando uma extensão de Protocolo de Idioma do Servidor](adding-an-lsp-extension.md)
#[Abrir pasta](open-folder.md)
##[Espaços de trabalho](workspaces.md)
##[Contextos de arquivo](workspace-file-contexts.md)
##[Indexação](workspace-indexing.md)
##[Serviços de linguagem](workspace-language-services.md)
...
## [Como diagnosticar atrasos na interface do usuário causados pelas extensões](how-to-diagnose-ui-delays-caused-by-extensions.md)
## [Solucionar problemas de VSPackages](troubleshooting-vspackages.md)
# [Shell (Integrado ou Isolado)](https://vspartner.com/pages/vsshells)
...
### [Referência de Esquema 2.0 do VSIX Language Pack](vsix-language-pack-schema-2-0-reference.md)
...
## [Localizando o Visual Studio](locating-visual-studio.md)
