...
5.  Teste as novas configurações de recompilar a solução e iniciar a depuração.  
...
2.  No `TestSearchTask` classe, retire os comentários a seguir linha o `OnStartSearch` método:  
