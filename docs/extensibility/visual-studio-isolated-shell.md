...
> [!NOTE]
>  Para obter mais informações sobre como implantar um aplicativo shell isolado, consulte [passo a passo: Criando um aplicativo de Shell isolado básico](../extensibility/walkthrough-creating-a-basic-isolated-shell-application.md).  
