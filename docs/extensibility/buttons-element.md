---
title: Botões elemento | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
Grupos de [botão](../extensibility/button-element.md) elementos, que representam comandos individuais.  
...
|[Elemento Button](../extensibility/button-element.md)|Define um comando que o usuário pode interagir com.|  
