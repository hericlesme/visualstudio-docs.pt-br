...
#### <a name="parameters"></a>Parâmetros  
 ...
 `ppField`  
 [out] Retorna o tipo de matriz que é representado por um [IDebugClassField](../../../extensibility/debugger/reference/idebugclassfield.md) interface.  
