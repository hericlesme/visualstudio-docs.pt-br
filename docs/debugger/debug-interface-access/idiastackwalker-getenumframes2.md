...
#### <a name="parameters"></a>Parâmetros  
 `cpuid`  
 [in] Um valor da [enumeração CV_CPU_TYPE_e](../../debugger/debug-interface-access/cv-cpu-type-e.md) enumeração, especificando o tipo de plataforma.  
...
## <a name="remarks"></a>Comentários  
 Para obter uma lista de quadro de pilha para apenas x86 plataforma, chame o [IDiaStackWalker::getEnumFrames](../../debugger/debug-interface-access/idiastackwalker-getenumframes.md) método.  
