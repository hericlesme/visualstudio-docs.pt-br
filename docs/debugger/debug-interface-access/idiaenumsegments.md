...
|[IDiaEnumSegments::Next](../../debugger/debug-interface-access/idiaenumsegments-next.md)|Recupera um número de segmentos na sequência de enumeração especificado.|  
...
|[IDiaEnumSegments::Clone](../../debugger/debug-interface-access/idiaenumsegments-clone.md)|Cria um enumerador que contém o mesmo estado de enumeração do enumerador atual.|  
...
## <a name="example"></a>Exemplo  
 Este exemplo mostra como obter o `IDiaEnumSections` interface de uma tabela. Para obter um exemplo mais completo de segmentos de uso, consulte o [IDiaSegment](../../debugger/debug-interface-access/idiasegment.md) interface.  
