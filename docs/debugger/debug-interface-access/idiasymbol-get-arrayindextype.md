...
## <a name="remarks"></a>Comentários  
 Alguns idiomas podem especificar o tipo usado como um índice em uma matriz. O símbolo retornado deste método especifica desse tipo.  
