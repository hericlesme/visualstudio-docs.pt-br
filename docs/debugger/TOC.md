...
## [Considerações sobre tipo de aplicativo](debugging-applications.md)
...
#### [Como disparar eventos de suspensão, retomada e na tela de fundo em aplicativos da Microsoft Store](how-to-trigger-suspend-resume-and-background-events-for-windows-store-apps-in-visual-studio.md)
