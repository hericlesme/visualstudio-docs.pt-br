...
## [Usar o coletor autônomo do IntelliTrace](using-the-intellitrace-stand-alone-collector.md)
## [Usar o Microsoft Monitoring Agent](using-the-microsoft-monitoring-agent.md)
## [Usar dados salvos do IntelliTrace](using-saved-intellitrace-data.md)
...
### [Perguntas frequentes sobre depuração de instantâneos](debug-live-azure-apps-troubleshooting-faq.md)
...
### [Executar aplicativos UWP do Visual Studio](run-store-apps-from-visual-studio.md)
#### [Executar aplicativos UWP no computador local](run-windows-store-apps-on-the-local-machine.md)
...
### [Depurar aplicativos UWP no Visual Studio](debug-store-apps-in-visual-studio.md)
#### [Iniciar uma sessão de depuração de um aplicativo UWP no Visual Studio (VB, C#, C++ e XAML)](start-a-debugging-session-for-a-store-app-in-visual-studio-vb-csharp-cpp-and-xaml.md)
...
#### [Iniciar uma sessão de depuração para aplicativos UWP no Visual Studio (JavaScript)](start-a-debugging-session-for-store-apps-in-visual-studio-javascript.md)
#### [Controlar a execução de um aplicativo UWP em uma sessão de depuração do Visual Studio (JavaScript)](control-execution-of-a-store-app-in-a-visual-studio-debug-session-for-windows-store-apps-javascript.md)
...
### [Depurar conteúdo de pré-busca em aplicativos UWP](prefetch-content-for-windows-store-apps.md)
