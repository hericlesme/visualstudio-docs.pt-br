...
Devido aos critérios de segurança, o IIS retornou um erro genérico.  
 ...
 Para obter mais informações sobre como solucionar problemas de IIS, consulte [administração e gerenciamento do IIS](/iis/manage/provisioning-and-managing-iis/iis-management-and-administration).  
