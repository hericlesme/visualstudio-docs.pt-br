...
Você pode alterar o formato no qual um valor é exibido no **inspecionar** janela usando especificadores de formato.  
 ...
 Você também pode usar os especificadores de formato no **imediato** janela, o **comando** janela e até mesmo no windows de origem. Se você pausar em uma expressão nessas janelas, o resultado aparecerá em uma DataTip. A exibição de DataTip reflete o especificador de formato.  
...
|su|wchar_t const *<br /><br /> char16_t const\*|\<local >|L "hello world"|  
|sub|wchar_t const *<br /><br /> char16_t const\*|\<local >|Olá, mundo|  
