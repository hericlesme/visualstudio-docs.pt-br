...
Exibição de janelas do Spy + +  
 ...
 Quando o modo de exibição do Windows tem o foco, você pode usar a ferramenta de localizador de [caixa de diálogo de pesquisa de janela](../debugger/window-search-dialog-box.md) para exibir informações de qualquer janela aberta em seu sistema.  
