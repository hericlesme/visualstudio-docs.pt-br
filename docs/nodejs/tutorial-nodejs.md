...
Neste tutorial, você aprendeu a criar e executar um aplicativo Node.js usando Express e a atingir um ponto de interrupção usando o depurador. Para obter mais informações, confira [Ferramentas Node.js para Visual Studio no GitHub](https://github.com/Microsoft/nodejstools).