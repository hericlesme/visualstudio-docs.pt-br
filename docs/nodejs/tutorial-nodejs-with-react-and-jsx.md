...
Neste tutorial, você aprendeu a criar um aplicativo Node.js e React, a transcompilar JSX e a depurar. Para obter mais informações, confira [Ferramentas Node.js para Visual Studio no GitHub](https://github.com/Microsoft/nodejstools).