---
title: "Convenções de nomenclatura do .NET para EditorConfig | Microsoft Docs"
ms.custom: 
ms.date: 11/20/2017
ms.reviewer: 
ms.suite: 
...
> [!NOTE]
> É necessário especificar um nível de acessibilidade como parte de sua convenção de nomenclatura; caso contrário, a convenção de nomenclatura poderá ser ignorada.
