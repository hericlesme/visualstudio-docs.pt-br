...
Nesta introdução de 5 a 10 minutos para mostrar como usar o Visual Studio, você criará um aplicativo "Olá, Mundo" simples usando um modelo de projeto do ASP.NET e a linguagem de programação C#.
...
Para saber mais, continue com os tutoriais a seguir:
