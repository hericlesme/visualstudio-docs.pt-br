---
title: "Navegando no código | Microsoft Docs"
ms.custom: 
ms.date: 09/26/2017
ms.reviewer: 
ms.suite: 
...
---
# <a name="navigating-code"></a>Navegando no código  
...
Ir para Definição leva para a definição do elemento selecionado. Para obter mais informações, consulte [Ir para Definição e Espiar Definição](../ide/go-to-and-peek-definition.md).  
...
Espiar Definição exibe a definição do elemento selecionado em uma janela sem sair do local atual no editor de código. Para obter mais informações, consulte [Como exibir e editar o código usando Espiar Definição](../ide/how-to-view-and-edit-code-by-using-peek-definition-alt-plus-f12.md) e [Ir para Definição e Espiar Definição](../ide/go-to-and-peek-definition.md).  
...
Hierarquia de chamadas mostra as chamadas para um método na janela Hierarquia de chamadas:  
