...
Neste procedimento, usaremos o mesmo trecho de código Hello World criado no [Passo a passo: criar um trecho de código](../ide/walkthrough-creating-a-code-snippet.md). Forneceremos o texto *.snippet*, portanto, você não precisa voltar e criar um.
