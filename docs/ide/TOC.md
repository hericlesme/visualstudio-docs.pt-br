...
## [Otimizar o desempenho do Visual Studio](optimize-visual-studio-startup-time.md)
## [Otimizar o carregamento da solução](optimize-solution-loading-in-visual-studio.md)
...
## [Lista de URLs aceitas em uma rede privada](whitelisting-urls-in-a-private-network.md)
...
#### [Configurações de estilo de código .NET para EditorConfig](editorconfig-code-style-settings-reference.md)
...
### [Ir para Definição e Definição de Pico](go-to-and-peek-definition.md)
