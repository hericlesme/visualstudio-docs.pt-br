...
### [Guia de início rápido: Criar um aplicativo de console do Visual Basic](../ide/quickstart-visual-basic-console.md)
...
#### [Preferências de estilo de código](code-styles-and-quick-actions.md)
...
### [IntelliSense do Visual Basic](visual-basic-specific-intellisense.md)
