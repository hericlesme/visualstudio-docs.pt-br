...
<h2>Experimente o Visual Studio com "Guias de Início Rápido" de 5 minutos</h2>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Escrever código no editor</h3>
                    </div>
                </div>
            </div>
        </div>
...
src="https://docs.microsoft.com/en-us/media/common/i_debug.svg"><span>Depuração</span></a></div>
