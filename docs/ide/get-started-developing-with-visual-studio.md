...
-   **[Crie aplicativos móveis de plataforma cruzada em HTML/Javascript (Apache Cordova)](http://taco.visualstudio.com/en-us/docs/get-started-first-mobile-app/)**: o Apache Cordova é um ambiente de plataforma cruzada de software livre baseado em HTML/CSS/Javascript. O código Javascript é executado em um wrapper que é direcionado a uma plataforma específica e permite o acesso a todos os recursos de hardware do dispositivo. Desenvolva aplicativos para a Apple Store, a loja do Android e a Microsoft Store.  
