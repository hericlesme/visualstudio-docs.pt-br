...
- [Instalar o software nos computadores](../ide/walkthrough-creating-a-multiple-computer-build-environment.md#InstallingSoftware)

- [Copiar arquivos do computador host para o computador de build](../ide/walkthrough-creating-a-multiple-computer-build-environment.md#CopyingFiles)

- [Criar configurações de Registro](../ide/walkthrough-creating-a-multiple-computer-build-environment.md#CreatingRegistry)

- [Definir variáveis de ambiente no computador de build](../ide/walkthrough-creating-a-multiple-computer-build-environment.md#SettingEnvVariables)

- [Instalar assemblies do MSBuild para o GAC (Cache de Assembly Global) no computador de build](../ide/walkthrough-creating-a-multiple-computer-build-environment.md#InstallingMSBuildToGAC)

- [Criar projetos](../ide/walkthrough-creating-a-multiple-computer-build-environment.md#BuildingProjects)

- [Criar o ambiente de build para que ele possa ter o check-in no controle do código-fonte](../ide/walkthrough-creating-a-multiple-computer-build-environment.md#CreatingForSourceControl)

## <a name="prerequisites"></a>Pré-requisitos

- O Visual Studio com a carga de trabalho de área de trabalho de desenvolvimento .NET instalada.

## <a name="InstallingSoftware"></a> Instalar o software nos computadores
...
2. No computador de build, instale o .NET Framework 4.5. Para verificar se ele está instalado, verifique se o valor da chave do Registro **HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\NET Framework Setup\NDP\v4\Full@Version** começa com "4.5".

## <a name="CopyingFiles"></a> Copiar arquivos do computador host para o computador de build
...
##  <a name="CreatingRegistry"></a> Criar configurações de Registro
...
## <a name="SettingEnvVariables"></a> Definir variáveis de ambiente no computador de build
...
## <a name="InstallingMSBuildToGAC"></a> Instalar assemblies do MSBuild para o GAC (Cache de Assembly Global) no computador de build
...
## <a name="BuildingProjects"></a> Criar projetos
...
## <a name="CreatingForSourceControl"></a> Criar o ambiente de build para que ele possa ter o check-in no controle do código-fonte
