...
* **Controladores** são classes que manipulam as solicitações do browser. Elas recuperam dados de modelo e chamam modelos de exibição que retornam uma resposta. Em um aplicativo MVC, a exibição mostra apenas informações; o controlador manipula e responde à entrada e à interação do usuário.
...
1. O Visual Studio abre uma janela do browser. Selecione **Sobre**.

 ![Selecione Sobre na janela do browser para seu aplicativo](../ide/media/csharp-aspnet-browser-page.png)
...
1. Mantenha a janela do browser aberta e retorne ao Visual Studio. Abra *Controllers/HomeController.cs* se ainda não estiver aberto.
...
1. Retornar à janela do browser para ver o texto atualizado. (Atualize o browser se o texto que você alterou não aparecer.)

  ![Atualizar a janela do browser para ver o texto alterado](../ide/media/csharp-aspnet-browser-page-about-changed.png)
