...
As regras de estilo nesta seção dizem respeito às preferências do modificador, incluindo a exigência de modificadores de acessibilidade e especificação da ordem de classificação de modificador desejada.  
...
| Nome da regra | ID da regra | Linguagens Aplicáveis | Padrão do Visual Studio | Versão compatível |
| --------- | ------- | -------------------- | ----------------------| ----------------  |
| dotnet_style_require_accessibility_modifiers | IDE0040 | C# e Visual Basic | for_non_interface_members:none | Visual Studio 2017 versão 15.5 |
| csharp_preferred_modifier_order | IDE0036 | C# | public,private,protected,internal,static,extern,new,virtual,abstract,sealed,override,readonly,unsafe,volatile,async:none | Visual Studio 2017 versão 15.5 |
| visual_basic_preferred_modifier_order | IDE0036 | Visual Basic | Partial,Default,Private,Protected,Public,Friend,NotOverridable,Overridable,MustOverride,Overloads,Overrides,MustInherit,NotInheritable,Static,Shared,Shadows,ReadOnly,WriteOnly,Dim,Const,WithEvents,Widening,Narrowing,Custom,Async:none | Visual Studio 2017 versão 15.5 |
...
| for_non_interface_members | Preferir que modificadores de acessibilidade sejam declarados, exceto os membros de interface pública. No momento, isso não será diferente de **always** e funcionará como preparação para o futuro caso C# adicione métodos de interface padrão. |
...
| Nome da regra | ID da regra | Linguagens Aplicáveis | Padrão do Visual Studio | Versão compatível |
| --------- | ------- | -------------------- | ----------------------| ----------------  |
| csharp_style_expression_bodied_methods | IDE0022 | C# 6.0+ | never:none | Visual Studio 2017 versão 15.3 |
| csharp_style_expression_bodied_constructors | IDE0021 | C# 7.0+ | never:none | Visual Studio 2017 versão 15.3 |
| csharp_style_expression_bodied_operators | IDE0023 e IDE0024 | C# 7.0+ | never:none | Visual Studio 2017 versão 15.3 |
| csharp_style_expression_bodied_properties | IDE0025 | C# 7.0+ | when_possible:none | Visual Studio 2017 versão 15.3 |
| csharp_style_expression_bodied_indexers | IDE0026 | C# 7.0+ | when_possible:none | Visual Studio 2017 versão 15.3 |
| csharp_style_expression_bodied_accessors | IDE0027 | C# 7.0+ | when_possible:none | Visual Studio 2017 versão 15.3 |  
...
| Valor | Descrição |
| ----- |:----------- |
| when_possible | Preferir membros aptos para expressão para métodos |
| when_on_single_line | Preferir membros aptos para expressão para métodos quando eles forem uma única linha |
| never | Preferir corpos de bloco para métodos | 
...
| Valor | Descrição |
| ----- |:----------- |
| when_possible | Preferir membros aptos para expressão para construtores |
| when_on_single_line | Preferir membros aptos para expressão para construtores quando eles forem uma única linha |
| never | Preferir blocos do corpo para construtores |  
...
| Valor | Descrição |
| ----- |:----------- |
| when_possible | Prefira membros aptos para expressão para operadores |
| when_on_single_line | Preferir membros aptos para expressão para operadores quando eles forem uma única linha |
| never | Preferir blocos do corpo para operadores |  
...
| Valor | Descrição |
| ----- |:----------- |
| when_possible | Prefira membros aptos para expressão para propriedades |
| when_on_single_line | Preferir membros aptos para expressão para propriedades quando elas forem uma única linha |
| never | Preferir blocos do corpo para propriedades |  
...
| Valor | Descrição |
| ----- |:----------- |
| when_possible | Preferir membros aptos para expressão para indexadores |
| when_on_single_line | Preferir membros aptos para expressão para indexadores quando eles forem uma única linha |
| never | Preferir blocos do corpo para indexadores | 
...
| Valor | Descrição |
| ----- |:----------- |
| when_possible | Preferir membros aptos para expressão para acessadores |
| when_on_single_line | Preferir membros aptos para expressão para acessadores quando eles forem uma única linha |
| never | Preferir blocos do corpo para acessadores | 
...
| Nome da regra | ID da regra | Linguagens Aplicáveis | Padrão do Visual Studio | Versão compatível |
| --------- | ------- | -------------------- | ----------------------| ----------------  |
| csharp_prefer_simple_default_expression | IDE0034 | C# 7.1+ | true:suggestion | Visual Studio 2017 versão 15.3 |
| csharp_style_deconstructed_variable_declaration | IDE0042 | C# 7.0+ | true:suggestion | Visual Studio 2017 versão 15.5 |
| csharp_style_pattern_local_over_anonymous_function | IDE0039 | C# 7.0+ | true:suggestion | Visual Studio 2017 versão 15.5 |
...
| Nome da regra | ID da regra | Linguagens Aplicáveis | Padrão do Visual Studio | Versão compatível |
| --------- | ------- | -------------------- | ----------------------| ----------------  |
| csharp_prefer_braces | IDE0011 | C# | true:none | Visual Studio 2017 versão 15.3 |
...
| Nome da regra | Linguagens Aplicáveis | Padrão do Visual Studio | Versão compatível |
| ----------- | -------------------- | ----------------------| ----------------  |
| dotnet_sort_system_directives_first |  C# e Visual Basic | true | Visual Studio 2017 versão 15.3  |
...
| Nome da regra | Linguagens Aplicáveis | Padrão do Visual Studio | Versão compatível |
| ----------- | -------------------- | ----------------------| ----------------  |
| csharp_new_line_before_open_brace |  C# | all | Visual Studio 2017 versão 15.3  |
| csharp_new_line_before_else |  C# | true | Visual Studio 2017 versão 15.3  |
| csharp_new_line_before_catch |  C# | true | Visual Studio 2017 versão 15.3  |
| csharp_new_line_before_finally |  C# | true | Visual Studio 2017 versão 15.3  |
| csharp_new_line_before_members_in_object_initializers |  C# | true | Visual Studio 2017 versão 15.3  |
| csharp_new_line_before_members_in_anonymous_types |  C# | true | Visual Studio 2017 versão 15.3  |
| csharp_new_line_between_query_expression_clauses |  C# | true | Visual Studio 2017 versão 15.3  |
...
| Nome da regra | Linguagens Aplicáveis | Padrão do Visual Studio | Versão compatível |
| ----------- | -------------------- | ----------------------| ----------------  |
| csharp_indent_case_contents |  C# | true | Visual Studio 2017 versão 15.3  |
| csharp_indent_switch_labels |  C# | true | Visual Studio 2017 versão 15.3  |
| csharp_indent_labels |  C# | no_change | Visual Studio 2017 versão 15.3  |
...
| Nome da regra | Linguagens Aplicáveis | Padrão do Visual Studio | Versão compatível |
| ----------- | -------------------- | ----------------------| ----------------  |
| csharp_space_after_cast |  C# | false | Visual Studio 2017 versão 15.3  |
| csharp_space_after_keywords_in_control_flow_statements |  C# | true | Visual Studio 2017 versão 15.3  |
| csharp_space_between_method_declaration_parameter_list_parentheses |  C# | false | Visual Studio 2017 versão 15.3  |
| csharp_space_between_method_call_parameter_list_parentheses |  C# | false | Visual Studio 2017 versão 15.3  |
| csharp_space_between_parentheses |  C# | false | Visual Studio 2017 versão 15.3  |
...
| Nome da regra | Linguagens Aplicáveis | Padrão do Visual Studio | Versão compatível |
| ----------- | -------------------- | ----------------------| ----------------  |
| csharp_preserve_single_line_statements |  C# | true | Visual Studio 2017 versão 15.3  |
| csharp_preserve_single_line_blocks |  C# | true | Visual Studio 2017 versão 15.3  |
