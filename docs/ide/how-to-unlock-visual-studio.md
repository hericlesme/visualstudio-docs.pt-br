...
2.  Insira as credenciais para uma conta da Microsoft ou uma conta corporativa ou de estudante. O Visual Studio encontrará uma assinatura do Visual Studio ou uma assinatura do Visual Studio Team Services associada à sua conta.  
