...
Para obter mais informações sobre tipos de arquivos em projetos do C++, consulte [Tipos de arquivo criados para projetos do Visual C++](/cpp/ide/file-types-created-for-visual-cpp-projects) e [Unicode na biblioteca Microsoft Foundation Class](/cpp/mfc/unicode-in-mfc)
