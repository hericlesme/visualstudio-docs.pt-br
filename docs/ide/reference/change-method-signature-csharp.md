---
title: "Refatorar uma assinatura de método em C# | Microsoft Docs"
ms.custom: 
ms.date: 11/16/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="change-a-method-signature-in-c"></a>Alterar assinatura de um método em C# #
...
1. realce ou coloque o cursor do texto dentro do nome do método para modificar, ou um de seus usos:
   ...
   ![Código realçado](media/changesignature-highlight-cs.png)
...
1. Quando tiver terminado, pressione o botão **OK** para fazer as alterações.
   ...
   ![Resultado de Alterar Assinatura](media/changesignature-result-cs.png)
