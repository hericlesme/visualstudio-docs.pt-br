---
title: Página Aplicativo, Designer de Projeto (C#)
ms.date: 11/04/2016
 ...
 **Tipo de aplicativo** Especifica o tipo de aplicativo a ser compilado. Para aplicativos do Windows 8.x, é possível especificar **Aplicativo da Windows Store**, **Biblioteca de Classes** ou **Arquivo WinMD**. Para a maioria dos outros tipos de aplicativo, é possível especificar **aplicativos do Windows**, **aplicativo de Console**, **Biblioteca de Classes**, **Serviço Windows** ou **Biblioteca de Controles da Web**.
