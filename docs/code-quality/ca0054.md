...
ms.locfileid: "31895696"
---
# <a name="ca0054"></a>CA0054
Assembly de regra personalizada tem os recursos XML inválido

 Isso ocorre se um assembly de regra personalizada tiver recursos XML inválido descrevendo suas regras. O formato correto é da seguinte maneira:
