...
A ferramenta de análise de código C/C++ fornece informações sobre defeitos possíveis no seu código-fonte C/C++. Entre os erros de codificação comuns reportados pela ferramenta estão estouros de buffer, memória não inicializada, desreferências de ponteiro nulo, memória e perdas de recurso. A ferramenta também pode executar verificações em relação a [diretrizes de núcleos de C++](http://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md).

## <a name="ide-integrated-development-environment-integration"></a>Integração de IDE (ambiente de desenvolvimento integrado)

A ferramenta de análise de código está totalmente integrada no Visual Studio IDE.
...
**Visual Studio 2017 versão 15.7 e posteriores** você pode executar a ferramenta de linha de comando com qualquer sistema de compilação incluindo CMake.
...
- [Referência de verificador de diretrizes do principal de C++](code-analysis-for-cpp-corecheck.md)
