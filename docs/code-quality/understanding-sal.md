...
2.  Na barra de menus, escolha **criar**, **executar análise de código na solução**.
    ...
    > **Valor de parâmetro inválido C6387** 'aponte' pode ser '0': isso não adere à especificação para a função 'InCallee'.
