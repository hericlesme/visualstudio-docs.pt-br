...
## [Analisadores de Roslyn](roslyn-analyzers-overview.md)
...
### [Instalar analisadores de Roslyn](install-roslyn-analyzers.md)
### [Configurar e usar analisadores de Roslyn](use-roslyn-analyzers.md)
### [Habilitar a análise de código automática](how-to-enable-and-disable-automatic-code-analysis-for-managed-code.md)
### [Habilitar análise de solução completa](how-to-enable-and-disable-full-solution-analysis-for-managed-code.md)
### [Suspensão automática de recursos](automatic-feature-suspension.md)
### [Executar a análise de código manualmente](how-to-run-code-analysis-manually-for-managed-code.md)
...
### [Definir propriedades de análise de código](how-to-set-code-analysis-properties-for-c-cpp-projects.md)
### [Usar anotações SAL para reduzir defeitos de código](using-sal-annotations-to-reduce-c-cpp-code-defects.md)
...
### [Usar conjuntos de regras para código gerenciado](how-to-configure-code-analysis-for-a-managed-code-project.md)
...
#### [Especificar conjuntos de regras para vários projetos](how-to-specify-managed-code-rule-sets-for-multiple-projects-in-a-solution.md)
### [Usar conjuntos de regras para código C++](using-rule-sets-to-specify-the-cpp-rules-to-run.md)
### [Sincronizar conjuntos de regras do projeto à política de check-in do projeto de equipe](how-to-synchronize-code-project-rule-sets-with-team-project-check-in-policy.md)
### [Criar conjuntos de regras personalizados](creating-custom-code-analysis-rule-sets.md)
#### [Criar um conjunto de regras personalizado](how-to-create-a-custom-rule-set.md)
#### [Usar o editor de conjunto de regras](working-in-the-code-analysis-rule-set-editor.md)
## [Criar políticas de check-in de análise de código](how-to-create-or-update-standard-code-analysis-check-in-policies.md)
...
### [Impor um código de fácil manutenção](how-to-enforce-maintainable-code-with-a-code-analysis-check-in-policy.md)
### [Compatibilidade de versão](version-compatibility-for-code-analysis-check-in-policies.md)
## Métricas de código
