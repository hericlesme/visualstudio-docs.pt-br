...
## [Conjuntos de regras](using-rule-sets-to-group-code-analysis-rules.md)
### [Conjuntos de regras para código gerenciado](how-to-configure-code-analysis-for-a-managed-code-project.md)
...
### [Conjuntos de regras para código C++](using-rule-sets-to-specify-the-cpp-rules-to-run.md)
...
## [Políticas de check-in](how-to-create-or-update-standard-code-analysis-check-in-policies.md)
...
### [Sincronizar conjuntos de regras do projeto à política de check-in da equipe](how-to-synchronize-code-project-rule-sets-with-team-project-check-in-policy.md)
...
# Referência
## [Conjuntos de regras](rule-set-reference.md)
