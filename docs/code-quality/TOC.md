# Visão geral
## [Análise de código para código gerenciado](code-analysis-for-managed-code-overview.md)
## [Análise de código para C/C++](code-analysis-for-c-cpp-overview.md)
## [Medir a manutenção de código com Métricas de Código](code-metrics-values.md)
# Guias de Início Rápido
## [Início Rápido: análise de código para C/C++](quick-start-code-analysis-for-c-cpp.md)
# Tutoriais
## [Analisar o código gerenciado para verificar defeitos de código](walkthrough-analyzing-managed-code-for-code-defects.md)
## [Analisar o código C/C++ para verificar defeitos](walkthrough-analyzing-c-cpp-code-for-defects.md)
### [Amostra de demonstração](demo-sample.md)
## [Configurar e usar um conjunto de regras personalizados](walkthrough-configuring-and-using-a-custom-rule-set.md)
# Guias de instruções
## Análise de código para código gerenciado
### [Habilitar e desabilitar a análise de código automática para código gerenciado](how-to-enable-and-disable-automatic-code-analysis-for-managed-code.md)
### [Habilitar e desabilitar análise de solução completa para código gerenciado](how-to-enable-and-disable-full-solution-analysis-for-managed-code.md)
### [Suspensão automática de recursos](automatic-feature-suspension.md)
### [Executar a análise de código manualmente para código gerenciado](how-to-run-code-analysis-manually-for-managed-code.md)
### [Suprimir avisos](in-source-suppression-overview.md)
#### [Suprimir avisos de análise de código para código gerenciado](how-to-suppress-code-analysis-warnings-for-generated-code.md)
### [Personalizar o dicionário de análise de código](how-to-customize-the-code-analysis-dictionary.md)
### [Métodos anônimos e análise de código](anonymous-methods-and-code-analysis.md)
### [Criar um item de trabalho para um defeito de código gerenciado](how-to-create-a-work-item-for-a-managed-code-defect.md)
...
### [Definir as propriedades de análise de código para projetos do C/C++](how-to-set-code-analysis-properties-for-c-cpp-projects.md)
### [Usar anotações de SAL para reduzir defeitos de código do C/C++](using-sal-annotations-to-reduce-c-cpp-code-defects.md)
#### [Entender o SAL](understanding-sal.md)
#### [Anotar parâmetros de função e valores de retorno](annotating-function-parameters-and-return-values.md)
#### [Anotar o comportamento da função](annotating-function-behavior.md)
#### [Anotar estruturas e classes](annotating-structs-and-classes.md)
#### [Anotar comportamento de bloqueio](annotating-locking-behavior.md)
#### [Especificar quando e onde uma anotação se aplica](specifying-when-and-where-an-annotation-applies.md)
#### [Funções intrínsecas](intrinsic-functions.md)
#### [Melhores práticas e exemplos (SAL)](best-practices-and-examples-sal.md)
### [Especificar informações de código adicionais usando __analysis_assume](how-to-specify-additional-code-information-by-using-analysis-assume.md)
## [Usar conjuntos de regras para agrupar regras de análise de código](using-rule-sets-to-group-code-analysis-rules.md)
### [Configurar a análise de código para um projeto de código gerenciado](how-to-configure-code-analysis-for-a-managed-code-project.md)
### [Configurar a análise de código para um aplicativo Web ASP.NET](how-to-configure-code-analysis-for-an-aspnet-web-application.md)
### [Sincronizar conjuntos de regras do projeto de código à política de check-in do projeto de equipe](how-to-synchronize-code-project-rule-sets-with-team-project-check-in-policy.md)
### [Especificar conjuntos de regras de código gerenciado para vários projetos em uma solução](how-to-specify-managed-code-rule-sets-for-multiple-projects-in-a-solution.md)
### [Criar conjuntos de regras de análise de código personalizados](creating-custom-code-analysis-rule-sets.md)
#### [Criar um conjunto de regras personalizado](how-to-create-a-custom-rule-set.md)
#### [Trabalhar no editor de conjunto de regras de análise de Código](working-in-the-code-analysis-rule-set-editor.md)
...
## [Melhorar a qualidade do código com políticas de check-in do projeto de equipe](enhancing-code-quality-with-team-project-check-in-policies.md)
### [Criar e usar políticas de check-in de análise de código](creating-and-using-code-analysis-check-in-policies.md)
#### [Criar ou atualizar políticas de check-in de análise de código padrão](how-to-create-or-update-standard-code-analysis-check-in-policies.md)
#### [Implementar políticas de check-in de análise de código personalizadas para código gerenciado](implementing-custom-code-analysis-check-in-policies-for-managed-code.md)
#### [Impor um código de fácil manutenção com uma política de check-in de análise de código](how-to-enforce-maintainable-code-with-a-code-analysis-check-in-policy.md)
...
## Métricas de código
### [Gerar dados de métricas do código](how-to-generate-code-metrics-data.md)
### [Trabalhar com os dados de métricas de código](working-with-code-metrics-data.md)
# Referência
...
#### [CA1026: parâmetros padrão não devem ser usados](ca1026-default-parameters-should-not-be-used.md)
...
#### [CA1053: os tipos de suporte estático não devem ter construtores](ca1053-static-holder-types-should-not-have-constructors.md)
...
#### [CA1309: usar StringComparison ordinal](ca1309-use-ordinal-stringcomparison.md)
...
#### [CA1504: examinar nomes de campo confusos](ca1504-review-misleading-field-names.md)
...
#### [CA1719: os nomes de parâmetro não devem corresponder aos nomes de membro](ca1719-parameter-names-should-not-match-member-names.md)
...
### [Avisos de portabilidade](portability-warnings.md)
...
#### [CA2117: os tipos APTCA só devem estender tipos base APTCA](ca2117-aptca-types-should-only-extend-aptca-base-types.md)
...
#### [CA2139: os métodos transparentes talvez não usem o atributo HandleProcessCorruptingExceptions](ca2139-transparent-methods-may-not-use-the-handleprocesscorruptingexceptions-attribute.md)
...
#### [CA2201: não acionar tipos de exceção reservados](ca2201-do-not-raise-reserved-exception-types.md)
...
#### [CA2228: não remeter formatos de recurso não lançados](ca2228-do-not-ship-unreleased-resource-formats.md)
