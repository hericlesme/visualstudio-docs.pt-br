...
## <a name="see-also"></a>Consulte também
 <xref:System.Runtime.InteropServices.ClassInterfaceAttribute?displayProperty=fullName> [Interoperação com código não gerenciado](/dotnet/framework/interop/index)