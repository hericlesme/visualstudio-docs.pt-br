...
## <a name="example"></a>Exemplo  
 O exemplo a seguir, na Microsoft intermediate language (MSIL), mostra um tipo que violam essa regra. Observe que essa regra não pode ser violada usando c# ou Visual Basic .NET.  
