...
As regras nativas recomendado enfocam os problemas mais críticos e comuns do código nativo, inclusive falhas potenciais de segurança e falhas de aplicativo.  Você deve incluir este conjunto de regras em qualquer conjunto personalizado que criar para seus projetos nativos.  Este conjunto foi projetado para trabalhar com a edição do Visual Studio Professional e superior.  
...
|[C6054](../code-quality/c6054.md)|Zero a falta de encerramento|  
...
|[C6216](../code-quality/c6216.md)|Conversão de compilador inserido inválido BOOL em HRESULT|  
|[C6217](../code-quality/c6217.md)|Teste inválido de HRESULT com NOT|  
|[C6220](../code-quality/c6220.md)|Comparação de HRESULT inválida como -1|  
...
|[C6242](../code-quality/c6242.md)|Liberação local forçada|  
|[C6248](../code-quality/c6248.md)|Criando DACL Null|  
...
|[C6259](../code-quality/c6259.md)|Código morto em bit a bit- ou limitados Switch|  
|[C6260](../code-quality/c6260.md)|Uso de aritmética de bytes|  
|[C6262](../code-quality/c6262.md)|Uso da pilha excessiva|  
...
|[C6279](../code-quality/c6279.md)|Incompatibilidade de exclusão de matriz escalar novo|  
|[C6280](../code-quality/c6280.md)|Incompatibilidade de desalocação de alocação de memória|  
|[C6281](../code-quality/c6281.md)|Precedência de relação de bit a bit|  
|[C6282](../code-quality/c6282.md)|Atribuição substitui o teste|  
|[C6283](../code-quality/c6283.md)|Incompatibilidade de Array-New Scalar-Delete primitivo|  
...
|[C6287](../code-quality/c6287.md)|Teste de redundância|  
|[C6288](../code-quality/c6288.md)|Inclusão mútua sobre lógico- e é False|  
|[C6289](../code-quality/c6289.md)|A exclusão mútua sobre lógico- ou é verdadeiro|  
...
|[C6292](../code-quality/c6292.md)|Contagens de loops de máximo|  
...
|[C6297](../code-quality/c6297.md)|Resultado do deslocamento da conversão para tamanho maior|  
|[C6299](../code-quality/c6299.md)|Campo de bits para comparação Boolean|  
...
|[C6308](../code-quality/c6308.md)|Vazamento de Realloc|  
...
|[C6332](../code-quality/c6332.md)|Parâmetro inválido VirtualFree|  
|[C6333](../code-quality/c6333.md)|Tamanho inválido de VirtualFree|  
|[C6335](../code-quality/c6335.md)|Vazamento de identificador de processo|  
|[C6381](../code-quality/c6381.md)|Desligamento informações ausentes|  
|[C6383](../code-quality/c6383.md)|Contagem de elementos Byte-saturação de Buffer de contagem|  
...
|[C6995](../code-quality/c6995.md)|Falha ao salvar arquivo de Log XML|  
...
|[C26110](../code-quality/c26110.md)|Chamador falhando ao tentar manter bloqueio|  
|[C26111](../code-quality/c26111.md)|Chamador falhando ao tentar liberar o bloqueio|  
...
|[C26117](../code-quality/c26117.md)|Liberar o bloqueio não mantido|  
|[C26140](../code-quality/c26140.md)|Erro de anotação SAL de simultaneidade|  
...
|[C28022](../code-quality/c28022.md)|As classes de função sobre esta função não coincidem com as classes de função no typedef utilizado para defini-lo.|  
|[C28023](../code-quality/c28023.md)|A função que está sendo atribuída ou passada deve ter um _Function_class\_ anotação para pelo menos uma da classe (s)|  
|[C28024](../code-quality/c28024.md)|O ponteiro de função que está sendo atribuído a é anotado com a classe de função, que não está na lista de classes de função.|  
...
|[C28137](../code-quality/c28137.md)|O argumento de variável deve ser uma constante (literal)|  
|[C28138](../code-quality/c28138.md)|O argumento constante deve ser variável|  
|[C28159](../code-quality/c28159.md)|Considere o uso de outra função.|  
...
|[C28164](../code-quality/c28164.md)|O argumento está sendo passado para uma função que espera um ponteiro para um objeto (e não um ponteiro para um ponteiro)|  
...
|[C28209](../code-quality/c28209.md)|A declaração do símbolo possui uma declaração conflitante|  
