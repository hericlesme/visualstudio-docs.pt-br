...
```
 ...
 Para ver um exemplo completo sobre como criar o descritor de segurança, consulte [criando um descritor de segurança para um novo objeto no C++](http://msdn.microsoft.com/library/aa446595.aspx). Para obter mais informações, consulte [criando um DACL](/windows/desktop/SecBP/creating-a-dacl).