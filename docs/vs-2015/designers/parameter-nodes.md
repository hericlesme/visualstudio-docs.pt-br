...
ms.locfileid: "47476322"
---
# <a name="parameter-nodes"></a>Nós de parâmetro
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [nós de parâmetro](https://docs.microsoft.com/visualstudio/designers/parameter-nodes).  
