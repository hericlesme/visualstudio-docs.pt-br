...
A versão mais recente deste tópico pode ser encontrada em [instruções passo a passo: criar um aplicativo de área de trabalho do WPF conectado a um serviço do Azure Mobile](https://docs.microsoft.com/visualstudio/designers/walkthrough-create-a-wpf-desktop-application-connected-to-an-azure-mobile-service).  
