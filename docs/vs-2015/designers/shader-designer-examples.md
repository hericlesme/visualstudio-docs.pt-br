...
ms.locfileid: "47474329"
---
# <a name="shader-designer-examples"></a>Exemplos do Designer de Sombreador
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [exemplos do Designer de sombreador](https://docs.microsoft.com/visualstudio/designers/shader-designer-examples).  
