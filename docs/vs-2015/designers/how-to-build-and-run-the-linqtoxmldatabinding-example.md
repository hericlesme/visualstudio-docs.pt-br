...
A versão mais recente deste tópico pode ser encontrada em [como: compilar e executar o exemplo de LinqToXmlDataBinding](https://docs.microsoft.com/visualstudio/designers/how-to-build-and-run-the-linqtoxmldatabinding-example).  
