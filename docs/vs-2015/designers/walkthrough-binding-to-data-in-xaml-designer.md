...
ms.locfileid: "47462324"
---
# <a name="walkthrough-binding-to-data-in-xaml-designer"></a>Passo a passo: associando dados no Designer XAML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [instruções passo a passo: associando dados no Designer XAML](https://docs.microsoft.com/visualstudio/designers/walkthrough-binding-to-data-in-xaml-designer).  
