...
ms.locfileid: "47466264"
---
# <a name="shader-designer-nodes"></a>Nós do Designer de Sombreador
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [nós do Designer de sombreador](https://docs.microsoft.com/visualstudio/designers/shader-designer-nodes).  
