...
ms.locfileid: "47461183"
---
# <a name="working-with-textures-and-images"></a>Trabalhando com texturas e imagens
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [trabalhando com texturas e imagens](https://docs.microsoft.com/visualstudio/designers/working-with-textures-and-images).  
