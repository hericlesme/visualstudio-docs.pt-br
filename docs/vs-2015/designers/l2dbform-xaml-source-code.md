...
ms.locfileid: "47461005"
---
# <a name="l2dbformxaml-source-code"></a>Código de L2DBForm.xaml
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [código-fonte L2DBForm.xaml](https://docs.microsoft.com/visualstudio/designers/l2dbform-xaml-source-code).  
