...
ms.locfileid: "47474608"
---
# <a name="how-to-model-3-d-terrain"></a>Como modelar terreno 3D
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [como: modelar terreno 3D](https://docs.microsoft.com/visualstudio/designers/how-to-model-3-d-terrain).  
