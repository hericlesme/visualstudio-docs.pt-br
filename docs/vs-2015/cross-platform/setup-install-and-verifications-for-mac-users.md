...
A versão mais recente deste tópico pode ser encontrada em [programa de instalação, instalação e verificações para usuários do Mac](https://docs.microsoft.com/visualstudio/cross-platform/setup-install-and-verifications-for-mac-users).  
