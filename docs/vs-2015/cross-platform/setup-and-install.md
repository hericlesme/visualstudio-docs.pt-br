...
ms.locfileid: "47464021"
---
# <a name="setup-and-install"></a>Instalar e configurar
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [instalar e configurar](https://docs.microsoft.com/visualstudio/cross-platform/setup-and-install).  
