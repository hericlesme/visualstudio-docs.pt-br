...
ms.locfileid: "47475670"
---
# <a name="writecontexttlogs"></a>WriteContextTLogs
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [WriteContextTLogs](https://docs.microsoft.com/visualstudio/msbuild/writecontexttlogs).  
