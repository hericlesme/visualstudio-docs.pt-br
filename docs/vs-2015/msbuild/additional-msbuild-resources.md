...
ms.locfileid: "47462139"
---
# <a name="additional-msbuild-resources"></a>Recursos adicionais do MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [recursos adicionais do MSBuild](https://docs.microsoft.com/visualstudio/msbuild/additional-msbuild-resources).  
