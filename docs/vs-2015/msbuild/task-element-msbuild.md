...
ms.locfileid: "47468048"
---
# <a name="task-element-msbuild"></a>Elemento Task (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [elemento Task (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/task-element-msbuild).  
