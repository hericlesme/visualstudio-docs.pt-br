...
ms.locfileid: "47463531"
---
# <a name="when-element-msbuild"></a>Elemento When (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [elemento When (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/when-element-msbuild).  
