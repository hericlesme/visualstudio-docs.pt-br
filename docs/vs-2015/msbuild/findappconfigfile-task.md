...
ms.locfileid: "47462440"
---
# <a name="findappconfigfile-task"></a>Tarefa FindAppConfigFile
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [tarefa FindAppConfigFile](https://docs.microsoft.com/visualstudio/msbuild/findappconfigfile-task).  
