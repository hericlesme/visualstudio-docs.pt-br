...
ms.locfileid: "47475971"
---
# <a name="aspnetcompiler-task"></a>Tarefa AspNetCompiler
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [usando a tarefa AspNetCompiler para pré-compilar aplicativos ASP.NET](https://docs.microsoft.com/visualstudio/msbuild/aspnetcompiler-task).  
