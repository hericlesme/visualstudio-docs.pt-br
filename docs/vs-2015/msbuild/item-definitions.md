...
ms.locfileid: "47464036"
---
# <a name="item-definitions"></a>Definições de itens
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [definições de Item](https://docs.microsoft.com/visualstudio/msbuild/item-definitions).  
