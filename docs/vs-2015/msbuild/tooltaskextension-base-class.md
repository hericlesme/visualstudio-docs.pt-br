...
ms.locfileid: "47468051"
---
# <a name="tooltaskextension-base-class"></a>Classe ToolTaskExtension (base)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [classe de Base de ToolTaskExtension](https://docs.microsoft.com/visualstudio/msbuild/tooltaskextension-base-class).  
