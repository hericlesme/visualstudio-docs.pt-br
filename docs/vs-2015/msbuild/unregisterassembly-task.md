...
ms.locfileid: "47476015"
---
# <a name="unregisterassembly-task"></a>Tarefa UnregisterAssembly
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [tarefa UnregisterAssembly](https://docs.microsoft.com/visualstudio/msbuild/unregisterassembly-task).  
