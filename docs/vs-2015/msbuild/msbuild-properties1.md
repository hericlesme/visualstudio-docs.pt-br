...
ms.locfileid: "47475885"
---
# <a name="msbuild-properties1"></a>Properties1 do MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [propriedades do MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-properties).  
