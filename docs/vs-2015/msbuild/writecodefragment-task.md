...
ms.locfileid: "47475116"
---
# <a name="writecodefragment-task"></a>Tarefa WriteCodeFragment
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [tarefa WriteCodeFragment](https://docs.microsoft.com/visualstudio/msbuild/writecodefragment-task).  
