...
ms.locfileid: "47473241"
---
# <a name="endtrackingcontext"></a>EndTrackingContext
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [EndTrackingContext](https://docs.microsoft.com/visualstudio/msbuild/endtrackingcontext).  
