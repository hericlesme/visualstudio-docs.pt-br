...
ms.locfileid: "47463888"
---
# <a name="createitem-task"></a>Tarefa CreateItem
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [tarefa CreateItem](https://docs.microsoft.com/visualstudio/msbuild/createitem-task).  
