...
ms.locfileid: "47475872"
---
# <a name="msbuild-glossary1"></a>Glossary1 do MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [Glossário do MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-glossary).  
