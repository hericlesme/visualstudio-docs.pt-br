...
ms.locfileid: "47461137"
---
# <a name="warning-task"></a>Tarefa Warning
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [tarefa de aviso](https://docs.microsoft.com/visualstudio/msbuild/warning-task).  
