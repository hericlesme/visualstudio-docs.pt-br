...
ms.locfileid: "47463879"
---
# <a name="signfile-task"></a>Tarefa SignFile
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [tarefa SignFile](https://docs.microsoft.com/visualstudio/msbuild/signfile-task).  
