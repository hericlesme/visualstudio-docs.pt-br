...
ms.locfileid: "47473976"
---
# <a name="how-to-configure-targets-and-tasks"></a>Como configurar destinos e tarefas
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [como: configurar destinos e tarefas](https://docs.microsoft.com/visualstudio/msbuild/how-to-configure-targets-and-tasks).  
