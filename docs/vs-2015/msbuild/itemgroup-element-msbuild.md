...
ms.locfileid: "47466716"
---
# <a name="itemgroup-element-msbuild"></a>Elemento ItemGroup (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [elemento ItemGroup (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/itemgroup-element-msbuild).  
