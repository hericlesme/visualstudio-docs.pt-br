...
ms.locfileid: "47464727"
---
# <a name="xmlpoke-task"></a>Tarefa XmlPoke
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [tarefa XmlPoke](https://docs.microsoft.com/visualstudio/msbuild/xmlpoke-task).  
