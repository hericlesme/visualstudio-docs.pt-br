...
A versão mais recente deste tópico pode ser encontrada em [exibição de funções – dados de instrumentação de memória do .NET](https://docs.microsoft.com/visualstudio/profiling/functions-view-dotnet-memory-instrumentation-data).  
