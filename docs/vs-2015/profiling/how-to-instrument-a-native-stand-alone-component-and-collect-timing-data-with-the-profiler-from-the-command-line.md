...
A versão mais recente deste tópico pode ser encontrada em [como: instrumentar um componente autônomo nativo e coletar dados de tempo com o Profiler na linha de comando](https://docs.microsoft.com/visualstudio/profiling/how-to-instrument-a-native-stand-alone-component-and-collect-timing-data-with-the-profiler-from-the-command-line).  
