...
ms.locfileid: "47476323"
---
# <a name="concurrency-visualizer-sdk"></a>SDK do Visualizador de Simultaneidade
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [SDK da visualização simultânea](https://docs.microsoft.com/visualstudio/profiling/concurrency-visualizer-sdk).  
