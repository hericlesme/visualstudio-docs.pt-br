...
ms.locfileid: "47460988"
---
# <a name="application-timeline"></a>Linha do Tempo do Aplicativo
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [analisar o consumo de recursos em aplicativos XAML no Visual Studio](https://docs.microsoft.com/visualstudio/profiling/application-timeline).  
