...
ms.locfileid: "47474196"
---
# <a name="stopprofile"></a>StopProfile
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [StopProfile](https://docs.microsoft.com/visualstudio/profiling/stopprofile).  
