...
ms.locfileid: "47466670"
---
# <a name="cvwritealert-function"></a>Função CvWriteAlert
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [função CvWriteAlert](https://docs.microsoft.com/visualstudio/profiling/cvwritealert-function).  
