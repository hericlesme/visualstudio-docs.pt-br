...
ms.locfileid: "47464702"
---
# <a name="sample-xsd-file-simple-schema"></a>Arquivo XSD de exemplo: esquema simples
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [arquivo XSD de exemplo: esquema simples](https://docs.microsoft.com/visualstudio/xml-tools/sample-xsd-file-simple-schema).  
