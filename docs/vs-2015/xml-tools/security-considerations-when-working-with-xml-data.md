...
A versão mais recente deste tópico pode ser encontrada em [considerações de segurança ao trabalhar com dados XML](https://docs.microsoft.com/visualstudio/xml-tools/security-considerations-when-working-with-xml-data).  
