...
ms.locfileid: "47461622"
---
# <a name="sample-xsd-file-relationships"></a>Arquivo XSD de exemplo: Relações
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [arquivo XSD de exemplo: relações](https://docs.microsoft.com/visualstudio/xml-tools/sample-xsd-file-relationships).  
