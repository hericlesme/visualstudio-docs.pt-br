# [Analisando a qualidade do aplicativo](analyzing-application-quality-by-using-code-analysis-tools.md)
## [Analisando a qualidade do código gerenciado](analyzing-managed-code-quality-by-using-code-analysis.md)
### [Visão geral da análise de código para código gerenciado](code-analysis-for-managed-code-overview.md)
### [Como habilitar e desabilitar a análise de código automática](how-to-enable-and-disable-automatic-code-analysis-for-managed-code.md)
### [Como habilitar e desabilitar a análise de solução completa](how-to-enable-and-disable-full-solution-analysis-for-managed-code.md)
### [Suspensão automática de recursos](automatic-feature-suspension.md)
### [Como executar a análise de código manualmente](how-to-run-code-analysis-manually-for-managed-code.md)
...
### [Como suprimir avisos para o código gerado](how-to-suppress-code-analysis-warnings-for-generated-code.md)
...
#### [Avisos por CheckId](code-analysis-warnings-for-managed-code-by-checkid.md)
...
##### [CA2101: especificar marshaling para argumentos de cadeia de caracteres P/Invoke](ca2101-specify-marshaling-for-p-invoke-string-arguments.md)
#### [Avisos de interoperabilidade](interoperability-warnings.md)
##### [CA1400: os pontos de entrada de P-Invoke devem existir](ca1400-p-invoke-entry-points-should-exist.md)
##### [CA1401: os P/Invokes não devem estar visíveis](ca1401-p-invokes-should-not-be-visible.md)
...
##### [CA1901: as declarações P/Invoke devem ser portáteis](ca1901-p-invoke-declarations-should-be-portable.md)
...
##### [CA5122: as declarações de P-Invoke não devem ser críticas para segurança](ca5122-p-invoke-declarations-should-not-be-safe-critical.md)
...
## [Analisando a qualidade do código C/C++](analyzing-c-cpp-code-quality-by-using-code-analysis.md)
...
#### [Práticas recomendadas e exemplos](best-practices-and-examples-sal.md)
...
### [Como especificar conjuntos de regras para vários projetos em uma solução](how-to-specify-managed-code-rule-sets-for-multiple-projects-in-a-solution.md)
### [Criando conjuntos de regras personalizados](creating-custom-code-analysis-rule-sets.md)
#### [Como criar um conjunto de regras personalizado](how-to-create-a-custom-rule-set.md)
#### [Trabalhando no Editor de Conjunto de Regras](working-in-the-code-analysis-rule-set-editor.md)
...
#### [Implementando políticas de check-in personalizadas para código gerenciado](implementing-custom-code-analysis-check-in-policies-for-managed-code.md)
...
## [Valores de métricas de código](code-metrics-values.md)
