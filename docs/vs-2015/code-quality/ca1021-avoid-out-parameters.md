...
ms.locfileid: "47587025"
---
# <a name="ca1021-avoid-out-parameters"></a>CA1021: evitar parâmetros de saída
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [CA1021: evitar parâmetros out](https://docs.microsoft.com/visualstudio/code-quality/ca1021-avoid-out-parameters).
