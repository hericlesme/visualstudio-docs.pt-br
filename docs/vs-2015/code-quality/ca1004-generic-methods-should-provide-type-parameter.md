...
A versão mais recente deste tópico pode ser encontrada em [CA1004: os métodos genéricos devem fornecer parâmetro de tipo](https://docs.microsoft.com/visualstudio/code-quality/ca1004-generic-methods-should-provide-type-parameter).
