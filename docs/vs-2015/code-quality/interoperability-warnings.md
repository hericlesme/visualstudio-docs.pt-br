...
ms.locfileid: "47476110"
---
# <a name="interoperability-warnings"></a>Avisos de interoperabilidade
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [avisos de interoperabilidade](https://docs.microsoft.com/visualstudio/code-quality/interoperability-warnings).  
