...
ms.locfileid: "47463500"
---
# <a name="native-minimum-rules-rule-set"></a>Conjunto de regras mínimas nativo
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [regras nativas do mínimo de conjunto de regras](https://docs.microsoft.com/visualstudio/code-quality/native-minimum-rules-rule-set).  
