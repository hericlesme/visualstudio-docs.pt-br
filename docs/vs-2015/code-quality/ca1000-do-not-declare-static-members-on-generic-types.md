...
A versão mais recente deste tópico pode ser encontrada em [CA1000: não declarar membros estáticos em tipos genéricos](https://docs.microsoft.com/visualstudio/code-quality/ca1000-do-not-declare-static-members-on-generic-types).
