...
ms.locfileid: "47467358"
---
# <a name="troubleshooting-quality-tools"></a>Solucionando problemas de ferramentas de qualidade
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [ferramentas de solução de problemas de qualidade](https://docs.microsoft.com/visualstudio/code-quality/troubleshooting-quality-tools).  
