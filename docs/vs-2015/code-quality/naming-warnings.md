...
ms.locfileid: "47462363"
---
# <a name="naming-warnings"></a>Avisos de nomenclatura
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [avisos de nomenclatura](https://docs.microsoft.com/visualstudio/code-quality/naming-warnings).  
