...
A versão mais recente deste tópico pode ser encontrada em [teste Windows UWP e aplicativos da Store 8.1 com testes de IU codificados](https://docs.microsoft.com/visualstudio/test/test-windows-store-8-1-apps-with-coded-ui-tests).  
