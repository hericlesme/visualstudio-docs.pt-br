...
A versão mais recente deste tópico pode ser encontrada em [qualidade do código C++ analisar de aplicativos da Store usando a análise de código estático do Visual Studio](https://docs.microsoft.com/visualstudio/test/analyze-cpp-code-quality-of-store-apps-using-visual-studio-static-code-analysis).  
