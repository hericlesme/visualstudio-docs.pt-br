...
A versão mais recente deste tópico pode ser encontrada em [suporte para configurações e plataformas para testes de IU codificados e gravações da ação](https://docs.microsoft.com/visualstudio/test/supported-configurations-and-platforms-for-coded-ui-tests-and-action-recordings).  
