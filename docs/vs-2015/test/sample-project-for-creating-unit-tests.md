...
ms.locfileid: "47467725"
---
# <a name="sample-project-for-creating-unit-tests"></a>Projeto de exemplo para criação de testes de unidade
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [projeto de exemplo para criar testes de unidade](https://docs.microsoft.com/visualstudio/test/sample-project-for-creating-unit-tests).  
