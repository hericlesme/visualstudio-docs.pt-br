...
A versão mais recente deste tópico pode ser encontrada em [testes de IU codificado de edição usando o Editor de teste de IU codificado](https://docs.microsoft.com/visualstudio/test/editing-coded-ui-tests-using-the-coded-ui-test-editor).  
