...
ms.locfileid: "47473760"
---
# <a name="ltinstallchecksgt-element-bootstrapper"></a>&lt;InstallChecks&gt; elemento (Bootstrapper)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [ &lt;InstallChecks&gt; elemento (Bootstrapper)](https://docs.microsoft.com/visualstudio/deployment/installchecks-element-bootstrapper).  
