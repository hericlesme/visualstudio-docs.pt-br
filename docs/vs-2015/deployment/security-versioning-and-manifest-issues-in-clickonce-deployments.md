...
A versão mais recente deste tópico pode ser encontrada em [segurança, controle de versão e problemas de manifesto em implantações do ClickOnce](https://docs.microsoft.com/visualstudio/deployment/security-versioning-and-manifest-issues-in-clickonce-deployments).  
