...
ms.locfileid: "47467671"
---
# <a name="ltcommandsgt-element-bootstrapper"></a>&lt;Comandos&gt; elemento (Bootstrapper)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [ &lt;comandos&gt; elemento (Bootstrapper)](https://docs.microsoft.com/visualstudio/deployment/commands-element-bootstrapper).  
