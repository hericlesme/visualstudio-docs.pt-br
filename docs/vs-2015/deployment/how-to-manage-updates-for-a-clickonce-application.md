...
A versão mais recente deste tópico pode ser encontrada em [como: gerenciar atualizações para um aplicativo ClickOnce](https://docs.microsoft.com/visualstudio/deployment/how-to-manage-updates-for-a-clickonce-application).  
