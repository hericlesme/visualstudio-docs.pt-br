...
ms.locfileid: "47462484"
---
# <a name="clickonce-deployment-manifest"></a>Manifesto de implantação do ClickOnce
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [manifesto de implantação do ClickOnce](https://docs.microsoft.com/visualstudio/deployment/clickonce-deployment-manifest).  
