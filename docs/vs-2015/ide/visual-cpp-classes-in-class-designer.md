...
ms.locfileid: "47462017"
---
# <a name="visual-c-classes-in-class-designer"></a>Classes do Visual C++ no Designer de Classe
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [Classes do Visual C++ no Designer de classe](https://docs.microsoft.com/visualstudio/ide/visual-cpp-classes-in-class-designer).  
