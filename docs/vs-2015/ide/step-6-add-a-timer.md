...
ms.locfileid: "47463462"
---
# <a name="step-6-add-a-timer"></a>Etapa 6: Adicionar um temporizador
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [etapa 6: adicionar um temporizador](https://docs.microsoft.com/visualstudio/ide/step-6-add-a-timer).  
