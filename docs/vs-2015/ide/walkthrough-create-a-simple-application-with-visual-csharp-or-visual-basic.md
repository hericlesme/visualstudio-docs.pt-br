...
A versão mais recente deste tópico pode ser encontrada em [instruções passo a passo: criar um aplicativo simples com o Visual c# ou Visual Basic](https://docs.microsoft.com/visualstudio/ide/walkthrough-create-a-simple-application-with-visual-csharp-or-visual-basic).  
