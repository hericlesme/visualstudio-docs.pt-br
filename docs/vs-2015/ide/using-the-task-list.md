...
ms.locfileid: "47460600"
---
# <a name="using-the-task-list"></a>Usando a lista de tarefas
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [usando a lista de tarefas](https://docs.microsoft.com/visualstudio/ide/using-the-task-list).  
