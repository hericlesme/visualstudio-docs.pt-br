...
A versão mais recente deste tópico pode ser encontrada em [atalhos de teclado padrão para comandos usados com frequência no Visual Studio](https://docs.microsoft.com/visualstudio/ide/default-keyboard-shortcuts-for-frequently-used-commands-in-visual-studio).  
