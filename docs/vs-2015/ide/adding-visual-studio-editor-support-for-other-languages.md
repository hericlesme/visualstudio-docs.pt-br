...
A versão mais recente deste tópico pode ser encontrada em [suporte do editor de adicionar o Visual Studio para outras linguagens](https://docs.microsoft.com/visualstudio/ide/adding-visual-studio-editor-support-for-other-languages).  
