...
A versão mais recente deste tópico pode ser encontrada em [como: gerenciar configurações de Build com configurações de desenvolvedor de Visual Basic aplicadas](https://docs.microsoft.com/visualstudio/ide/how-to-manage-build-configurations-with-visual-basic-developer-settings-applied).  
