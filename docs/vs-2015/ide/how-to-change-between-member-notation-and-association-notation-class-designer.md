...
A versão mais recente deste tópico pode ser encontrada em [como: alterar entre notação de membro e notação de associação (Designer de classe)](https://docs.microsoft.com/visualstudio/ide/how-to-change-between-member-notation-and-association-notation-class-designer).  
