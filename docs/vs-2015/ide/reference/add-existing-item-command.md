...
ms.locfileid: "47476007"
---
# <a name="add-existing-item-command"></a>Comando Adicionar Item Existente
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [adicionar comando de Item existentes](https://docs.microsoft.com/visualstudio/ide/reference/add-existing-item-command).  
