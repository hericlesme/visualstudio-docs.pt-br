...
ms.locfileid: "47475591"
---
# <a name="toolbox-html-tab"></a>Caixa de Ferramentas, Guia HTML
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [caixa de ferramentas, guia HTML](https://docs.microsoft.com/visualstudio/ide/reference/toolbox-html-tab).  
