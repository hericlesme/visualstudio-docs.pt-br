...
ms.locfileid: "47466120"
---
# <a name="prerequisites-dialog-box"></a>Caixa de diálogo Pré-requisitos
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [caixa de diálogo de pré-requisitos](https://docs.microsoft.com/visualstudio/ide/reference/prerequisites-dialog-box).  
