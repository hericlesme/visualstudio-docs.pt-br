...
ms.locfileid: "47463241"
---
# <a name="step-3-assign-a-random-icon-to-each-label"></a>Etapa 3: Atribuir um ícone aleatório a cada rótulo
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [etapa 3: atribuir um ícone aleatório a cada rótulo](https://docs.microsoft.com/visualstudio/ide/step-3-assign-a-random-icon-to-each-label).  
