...
A versão mais recente deste tópico pode ser encontrada em [etapa 5: adicionar manipuladores de eventos Enter para os controles NumericUpDown](https://docs.microsoft.com/visualstudio/ide/step-5-add-enter-event-handlers-for-the-numericupdown-controls).  
