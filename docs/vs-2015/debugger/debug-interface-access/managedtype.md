...
ms.locfileid: "47468308"
---
# <a name="managedtype"></a>ManagedType
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [ManagedType](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/managedtype).  
