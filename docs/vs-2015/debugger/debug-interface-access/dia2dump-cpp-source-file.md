...
ms.locfileid: "47466661"
---
# <a name="dia2dumpcpp-source-file"></a>Arquivo de origem Dia2dump.cpp
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [de origem Dia2dump.cpp](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/dia2dump-cpp-source-file).  
