...
ms.locfileid: "47476109"
---
# <a name="pointertype"></a>PointerType
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [PointerType](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/pointertype).  
