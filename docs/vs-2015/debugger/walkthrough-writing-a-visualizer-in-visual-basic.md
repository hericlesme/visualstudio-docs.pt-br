...
A versão mais recente deste tópico pode ser encontrada em [instruções passo a passo: escrevendo um visualizador em Visual Basic](https://docs.microsoft.com/visualstudio/debugger/walkthrough-writing-a-visualizer-in-visual-basic).  
