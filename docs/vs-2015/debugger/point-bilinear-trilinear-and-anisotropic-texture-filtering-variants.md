...
A versão mais recente deste tópico pode ser encontrada em [ponto, Bilinear, Trilinear e variantes de filtragem de textura Anisotrópica](https://docs.microsoft.com/visualstudio/debugger/graphics/point-bilinear-trilinear-and-anisotropic-texture-filtering-variants).  
