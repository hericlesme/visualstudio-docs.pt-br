...
ms.locfileid: "47476291"
---
# <a name="groups-element"></a>Elemento Groups
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [elemento Groups](https://docs.microsoft.com/visualstudio/extensibility/groups-element).  
