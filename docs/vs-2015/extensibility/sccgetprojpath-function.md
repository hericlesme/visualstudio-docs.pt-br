...
ms.locfileid: "47462214"
---
# <a name="sccgetprojpath-function"></a>Função SccGetProjPath
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [função SccGetProjPath](https://docs.microsoft.com/visualstudio/extensibility/sccgetprojpath-function).  
