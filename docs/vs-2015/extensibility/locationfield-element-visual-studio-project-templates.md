...
A versão mais recente deste tópico pode ser encontrada em [elemento LocationField (modelos de projeto do Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/locationfield-element-visual-studio-project-templates).  
