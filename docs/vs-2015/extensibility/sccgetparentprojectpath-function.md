...
ms.locfileid: "47473219"
---
# <a name="sccgetparentprojectpath-function"></a>Função SccGetParentProjectPath
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [função SccGetParentProjectPath](https://docs.microsoft.com/visualstudio/extensibility/sccgetparentprojectpath-function).  
