...
ms.locfileid: "47467017"
---
# <a name="package-guids-of-visual-studio-features"></a>GUIDs de pacote de recursos do Visual Studio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [pacote GUIDs de recursos do Visual Studio](https://docs.microsoft.com/visualstudio/extensibility/package-guids-of-visual-studio-features).  
