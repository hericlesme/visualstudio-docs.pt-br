...
ms.locfileid: "47462590"
---
# <a name="project-configuration-for-output"></a>Configuração de projeto para saída
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [configuração do projeto para saída](https://docs.microsoft.com/visualstudio/extensibility/internals/project-configuration-for-output).  
