...
ms.locfileid: "47460925"
---
# <a name="how-to-implement-nested-projects"></a>Como: implementar projetos aninhados
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [como: implementar aninhados projetos](https://docs.microsoft.com/visualstudio/extensibility/internals/how-to-implement-nested-projects).  
