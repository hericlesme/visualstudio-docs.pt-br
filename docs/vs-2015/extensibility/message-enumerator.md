...
ms.locfileid: "47460633"
---
# <a name="message-enumerator"></a>Enumerador de mensagem
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [enumerador de mensagem](https://docs.microsoft.com/visualstudio/extensibility/message-enumerator).  
