...
ms.locfileid: "47464865"
---
# <a name="scccreatesubproject-function"></a>Função SccCreateSubProject
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [função SccCreateSubProject](https://docs.microsoft.com/visualstudio/extensibility/scccreatesubproject-function).  
