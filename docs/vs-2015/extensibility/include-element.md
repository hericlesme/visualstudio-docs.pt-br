...
ms.locfileid: "47467351"
---
# <a name="include-element"></a>Elemento Include
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [incluem o elemento](https://docs.microsoft.com/visualstudio/extensibility/include-element).  
