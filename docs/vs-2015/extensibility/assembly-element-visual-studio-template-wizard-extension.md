...
A versão mais recente deste tópico pode ser encontrada em [elemento Assembly (modelo de Assistente de extensão do Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/assembly-element-visual-studio-template-wizard-extension).  
