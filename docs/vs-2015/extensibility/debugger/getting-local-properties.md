...
ms.locfileid: "47461844"
---
# <a name="getting-local-properties"></a>Obtendo as propriedades do local
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [Obtendo propriedades locais](https://docs.microsoft.com/visualstudio/extensibility/debugger/getting-local-properties).  
