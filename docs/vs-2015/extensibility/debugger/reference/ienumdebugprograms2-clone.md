...
ms.locfileid: "47464358"
---
# <a name="ienumdebugprograms2clone"></a>IEnumDebugPrograms2::Clone
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [IEnumDebugPrograms2::Clone](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugprograms2-clone).  
