...
ms.locfileid: "47474327"
---
# <a name="ienumdebugthreads2skip"></a>IEnumDebugThreads2::Skip
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [IEnumDebugThreads2::Skip](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugthreads2-skip).  
