...
ms.locfileid: "47473793"
---
# <a name="ienumcodepaths2skip"></a>IEnumCodePaths2::Skip
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [IEnumCodePaths2::Skip](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumcodepaths2-skip).  
