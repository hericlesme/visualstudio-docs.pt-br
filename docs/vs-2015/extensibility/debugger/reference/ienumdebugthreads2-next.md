...
ms.locfileid: "47473839"
---
# <a name="ienumdebugthreads2next"></a>IEnumDebugThreads2::Next
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [IEnumDebugThreads2::Next](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugthreads2-next).  
