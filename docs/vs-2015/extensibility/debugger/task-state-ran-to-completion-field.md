...
ms.locfileid: "47462424"
---
# <a name="taskstaterantocompletion-field"></a>Campo TASK_STATE_RAN_TO_COMPLETION
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [campo TASK_STATE_RAN_TO_COMPLETION](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-state-ran-to-completion-field).  
