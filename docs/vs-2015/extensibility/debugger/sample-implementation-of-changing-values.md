...
ms.locfileid: "47473697"
---
# <a name="sample-implementation-of-changing-values"></a>Exemplo de implementação de valores de variáveis
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [implementação de alterar valores de exemplo](https://docs.microsoft.com/visualstudio/extensibility/debugger/sample-implementation-of-changing-values).  
