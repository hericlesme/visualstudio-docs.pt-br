...
ms.locfileid: "47465027"
---
# <a name="ide-constants"></a>Constantes do IDE
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

A versão mais recente deste tópico pode ser encontrada em [constantes de IDE](https://docs.microsoft.com/visualstudio/extensibility/ide-constants).  
