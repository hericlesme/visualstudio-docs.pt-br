...
No momento, o Serviço R Remoto para Linux está empacotado como rtvs-daemon. O daemon é compatível com a área de trabalho e o servidor Ubuntu 16.04, 16.10 LTS e com o Subsistema Windows para o Linux em execução no Ubuntu e testado neles. A maior parte deste tópico fornece instruções para configurar o Serviço R Remoto nesses diferentes sistemas.
