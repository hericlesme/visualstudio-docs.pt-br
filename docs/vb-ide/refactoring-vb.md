---
title: "Refatoração de recursos do Visual Basic | Microsoft Docs"
ms.custom: 
ms.date: 02/27/2017
ms.reviewer: 
ms.suite: 
...
Visual Basic oferece os seguintes recursos de refatoração:
...
[Refatoração em c#](../csharp-ide/refactoring-csharp.md)