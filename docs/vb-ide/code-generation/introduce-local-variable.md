---
title: "Apresentar uma variável local - geração de código (Visual Basic) | Microsoft Docs"
ms.custom: 
ms.date: 11/17/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="introduce-a-local-variable-in-visual-basic"></a>Apresentar uma variável local no Visual Basic
