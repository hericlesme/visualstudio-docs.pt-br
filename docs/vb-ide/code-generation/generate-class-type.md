---
title: "Gerar uma classe ou tipo - geração de código (Visual Basic) | Microsoft Docs"
ms.custom: 
ms.date: 11/17/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="generate-a-class-or-type-in-visual-basic"></a>Gerar uma classe ou um tipo no Visual Basic
