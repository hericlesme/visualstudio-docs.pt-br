---
title: Editando testes de interface do usuário codificados no Visual Studio
ms.date: 11/04/2016
...
- Se a janela Propriedades não for exibida, pressione e segure a tecla **Alt** ao mesmo tempo em que pressiona **Enter** ou pressione a tecla **F4**.

- Para desfazer as alterações de propriedade, selecione **Desfazer** no menu **Editar** ou pressione Ctrl+Z.
