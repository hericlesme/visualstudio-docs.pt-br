...
### [Início rápido](getting-started-with-unit-testing.md)
...
### [Manual de referência do IntelliTest](intellitest-manual/introduction.md)
...
#### [Escrever testes de unidade para DLLs C/C++](how-to-write-unit-tests-for-cpp-dlls.md)
...
### [Testar aplicativos UWP do Windows com testes de IU codificados](test-windows-store-8-1-apps-with-coded-ui-tests.md)
...
## [Como testar aplicativos UWP com o Visual Studio](testing-store-apps-with-visual-studio.md)
### [Criar e executar testes de unidade para um aplicativo UWP no Visual Studio](create-and-run-unit-tests-for-a-store-app-in-visual-studio.md)
#### [Teste de unidade de uma DLL do Visual C++ para aplicativos UWP](unit-testing-a-visual-cpp-dll-for-store-apps.md)
#### [Testes de unidade de código do Visual C# em um aplicativo UWP](unit-testing-visual-csharp-code-in-a-store-app.md)
#### [Executar testes de unidade para aplicativos UWP no Visual Studio](run-unit-tests-for-store-apps-in-visual-studio.md)
### [Analisar a qualidade do código de aplicativos UWP usando a análise de código estático do Visual Studio](analyze-the-code-quality-of-store-apps-using-visual-studio-static-code-analysis.md)
#### [Analisar a qualidade do código do Visual Basic e C# em aplicativos UWP usando a análise de código estático do Visual Studio](analyze-visual-basic-and-csharp-code-quality-in-store-apps-using-visual-studio-static-code-analysis.md)
#### [Analisar a qualidade do código C++ de aplicativos UWP usando a análise de código estático do Visual Studio](analyze-cpp-code-quality-of-store-apps-using-visual-studio-static-code-analysis.md)
...
### [Atualizar SCVMM 2008 R2 para SCVMM 2012](lab-management/upgrade-scvmm-2008-r2-scvmm-2012.md)
