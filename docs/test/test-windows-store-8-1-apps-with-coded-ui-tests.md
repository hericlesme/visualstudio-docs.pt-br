---
title: Testar aplicativos da UWP do Windows com testes de interface do usuário codificados no Visual Studio
ms.date: 11/04/2016
...
5.  Pressione **F5** para executar seu aplicativo da UWP.
...
### <a name="q-can-i-create-coded-ui-tests-for-my-uwp-apps-on-a-system-that-is-not-running-windows-81-or-windows-10"></a>P: Posso criar testes de IU codificados para meus aplicativos da UWP em um sistema que não está executando o Windows 8.1 nem o Windows 10?
