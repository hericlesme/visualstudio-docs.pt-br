...
|----------|-----------------------------|  
|**Iniciar um aplicativo**|-   [Aplicativos independentes](../profiling/how-to-launch-a-stand-alone-application-with-the-profiler-and-collect-application-statistics-by-using-the-command-line.md)|  
...
-   [Componentes independentes do .NET Framework](../profiling/how-to-instrument-a-stand-alone-dotnet-framework-component-and-collect-timing-data-with-the-profiler-from-the-command-line.md)  
  
-   [Componentes independentes nativos](../profiling/how-to-instrument-a-native-stand-alone-component-and-collect-timing-data-with-the-profiler-from-the-command-line.md)  
...
|Tarefa|Tipo de aplicativo de destino|  
|----------|-----------------------------|  
|**Iniciar um aplicativo**|-   [Aplicativos .NET Framework independentes](../profiling/how-to-launch-a-stand-alone-dotnet-framework-application-with-the-profiler-to-collect-memory-data-by-using-the-command-line.md)|  
