---
title: construtor propriedade (intl. DateTimeFormat) | Microsoft Docs
ms.custom: 
ms.date: 01/18/2017
...
---
# <a name="constructor-property-intldatetimeformat"></a>Propriedade constructor (Intl.DateTimeFormat)
...
## <a name="remarks"></a>Comentários  
 Obrigatório `dateTimeFormatter` é o nome do formatador.  
