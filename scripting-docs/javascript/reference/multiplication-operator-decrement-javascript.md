---
title: Operador de multiplicação (*) (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24638396"
---
# <a name="multiplication-operator--javascript"></a>Operador de multiplicação (*) (JavaScript)
...
## <a name="see-also"></a>Consulte também  
 [Operador de atribuição de multiplicação (* =)](../../javascript/reference/multiplication-assignment-operator-decrement-equal-javascript.md)   
