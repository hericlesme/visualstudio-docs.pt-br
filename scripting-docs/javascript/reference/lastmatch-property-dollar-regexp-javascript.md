---
title: Propriedade lastMatch ($&amp;) (RegExp) (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24637836"
---
# <a name="lastmatch-property-amp-regexp-javascript"></a>Propriedade lastMatch ($&amp;) (RegExp) (JavaScript)
Retorna os últimos caracteres correspondentes de qualquer pesquisa de expressão regular. Somente leitura.  
...
## <a name="remarks"></a>Comentários  
 ...
 O valor inicial de `lastMatch` propriedade é uma cadeia de caracteres vazia. O valor de `lastMatch` propriedade alterada sempre que uma correspondência é feita.  
  
## <a name="example"></a>Exemplo  
 O exemplo a seguir ilustra o uso da propriedade `lastMatch`:  
