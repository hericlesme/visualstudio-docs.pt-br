---
title: Operador de divisão (-) (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24636306"
---
# <a name="division-operator---javascript"></a>Operador de divisão (-) (JavaScript)
Divide o valor de duas expressões.  
...
## <a name="see-also"></a>Consulte também  
 [Operador de atribuição de divisão (/ =)](../../javascript/reference/division-assignment-operator-decrement-equal-javascript.md)   
