---
title: Método (Uint8Array) subarray | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24640036"
---
# <a name="subarray-method-uint8array"></a>Método subarray (Uint8Array)
Obtém uma nova exibição Uint8Array do [ArrayBuffer Object](../../javascript/reference/arraybuffer-object.md) armazenar para essa matriz, especificando o primeiro e o último membro da submatriz.  
