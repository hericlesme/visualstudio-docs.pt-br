---
title: Método (Float32Array) subarray | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24639866"
---
# <a name="subarray-method-float32array"></a>Método subarray (Float32Array)
Obtém uma nova exibição Float32Array do [ArrayBuffer Object](../../javascript/reference/arraybuffer-object.md) armazenar para essa matriz, especificando o primeiro e o último membro da submatriz.  
