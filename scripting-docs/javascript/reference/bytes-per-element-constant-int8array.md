---
title: Constante BYTES_PER_ELEMENT (Int8Array) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24633896"
---
# <a name="bytesperelement-constant-int8array"></a>Constante BYTES_PER_ELEMENT (Int8Array)
