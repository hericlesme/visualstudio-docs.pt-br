---
title: Função Math TANH (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24638656"
---
# <a name="mathtanh-function-javascript"></a>Função Math.tanh (JavaScript)
...
## <a name="remarks"></a>Comentários  
 O valor retornado é o mesmo que `(exp(x) - exp(-x))/(exp(x) + exp(-x))`. Se `x` for `NaN`, o resultado é `NaN`.  
...
## <a name="see-also"></a>Consulte também  
 ...
 [Função Math.sinh](../../javascript/reference/math-sinh-function-javascript.md)