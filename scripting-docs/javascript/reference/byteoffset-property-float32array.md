---
title: Propriedade (Float32Array) byteOffset | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24633516"
---
# <a name="byteoffset-property-float32array"></a>Propriedade byteOffset (Float32Array)
