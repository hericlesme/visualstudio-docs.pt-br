---
title: Constante BYTES_PER_ELEMENT (Float64Array) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24634066"
---
# <a name="bytesperelement-constant-float64array"></a>Constante BYTES_PER_ELEMENT (Float64Array)
