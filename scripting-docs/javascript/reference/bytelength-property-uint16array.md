---
title: Propriedade (Uint16Array) byteLength | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24633816"
---
# <a name="bytelength-property-uint16array"></a>Propriedade byteLength (Uint16Array)
