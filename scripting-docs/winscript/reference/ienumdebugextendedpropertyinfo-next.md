...
#### <a name="parameters"></a>Parâmetros  
 ...
 `rgelt`  
 [out] Uma matriz de `ExtendedDebugPropertyInfo` estruturas recuperadas.  
  
 `pceltFetched`  
 [out] O número de `ExtendedDebugPropertyInfo` estruturas realmente recuperadas.  
