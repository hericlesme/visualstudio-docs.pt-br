...
Inicia o ambiente de desenvolvimento integrado (IDE) do depurador padrão e anexa uma sessão de depuração para este aplicativo, se uma já não está anexada.  
