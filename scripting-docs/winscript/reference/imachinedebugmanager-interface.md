...
A principal interface para o Gerenciador de depuração de máquina. Essa interface é semelhante do `IMachineDebugManagerCookie` interface.  
...
|[IMachineDebugManager::EnumApplications](../../winscript/reference/imachinedebugmanager-enumapplications.md)|Retorna um enumerador da lista atual de execução de aplicativos.|  
