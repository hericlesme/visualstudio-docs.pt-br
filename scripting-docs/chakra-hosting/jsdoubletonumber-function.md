---
title: Função JsDoubleToNumber | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24567916"
---
# <a name="jsdoubletonumber-function"></a>Função JsDoubleToNumber
Cria um valor numérico de um valor `double`.  
...
#### <a name="parameters"></a>Parâmetros  
 `doubleValue`  
 O `double` a converter para um valor numérico.  
