...
---
# <a name="administrator-overview"></a>Visão geral sobre administrador
## <a name="roles--responsibilities"></a>Funções e responsabilidades
Em troca de um desconto em produtos e serviços da Microsoft, sua organização concorda com certas responsabilidades e limitações relacionadas às assinaturas do Visual Studio. Um administrador do Visual Studio tem quatro responsabilidades principais:
...
4.  **Controlar as alterações de atribuição dos usuários e adquirir licenças adicionais de acordo com um agendamento.** Os contratos de Licenciamento por Volume da Microsoft oferecem flexibilidade na maneira como você usa e atribui as assinaturas do Visual Studio. Em troca, é esperado que você controle as alterações em relação ao uso do software e atribuições de usuário, e também processe os pedidos de licenças adicionais de acordo com o agendamento descrito no contrato.

## <a name="benefits-and-limitations"></a>Benefícios e limitações
As assinaturas do Visual Studio permitem que os membros da equipe de desenvolvimento instalem e usem o software para projetar, desenvolver, testar, avaliar e demonstram outros softwares. As assinaturas de software do Visual Studio não estão licenciadas para ambientes de produção. 

|                                          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Licenciamento baseado no usuário                     | As Plataformas MSDN e todos os níveis de assinaturas do Visual Studio são licenciados por usuário. Cada membro da equipe de desenvolvimento, que vai interagir (instalar, configurar ou acessar) com o software que acompanha esses produtos e serviços, requer sua própria assinatura do Visual Studio.                                                                                                                                                                                                                                                                                                                                  |
...
## <a name="large-teams-and-internal-contractors"></a>Equipes grandes e prestadores de serviço internos
...
1.  Os administradores de assinaturas do Visual Studio podem aumentar a marca d'água alta de uso, atribuindo assinaturas do Visual Studio para pessoas físicas.
...
3.  Os administradores de assinaturas do Visual Studio podem alterar o nível de assinatura atribuído de um indivíduo, o que constituiria na diminuição em uma atribuição e um aumento em outra. Ao diminuir o nível de assinatura atribuído de um assinante, a pessoa deve imediatamente parar de usar e desinstalar tudo o que está somente na assinatura de nível mais alto. 

### <a name="open-license-and-open-value"></a>Open License e Open Value
Talvez você esteja atribuindo assinaturas por meio de outro programa de Licenciamento por Volume da Microsoft como o Microsoft Open License ou Open Value. Nesse caso, você deve processar seu pedido de usuários adicionais durante o mês no qual os usuários (funcionários ou prestadores de serviço externos) começam a interagir com o software licenciado do Visual Studio.
