...
## <a name="eligibililty"></a>Qualificação 
...
Visite a documentação do [Suporte Técnico](/visualstudio/subscriptions/vs-tech-support) para encontrar os detalhes completos. 
...
Compare todas as [assinaturas e seus benefícios](https://www.visualstudio.com/vs/pricing/).

Se você tiver outra assinatura ativa do Visual Studio no **mesmo** nível de assinatura em uma conta da Microsoft, você poderá vinculá-la a este benefício do Azure adicionando uma [alternativa conta](/manage-vs-subscriptions#linking-my-subscription-to-existing-vsts-or-azure-subscriptions/) no portal de assinaturas do Visual Studio. Se isso não funcionar, você também poderá tentar [transferir o benefício do Azure](/azure/billing/billing-subscription-transfer/) para a assinatura ativa do Visual Studio.
