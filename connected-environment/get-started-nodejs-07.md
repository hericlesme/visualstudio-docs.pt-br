---
title: Criar um ambiente de desenvolvimento Node.js com contêineres usando o Kubernetes na nuvem – Etapa 7 – Resumo | Microsoft Docs
author: ghogen
ms.author: ghogen
ms.date: 02/20/2018
ms.topic: tutorial
...
ms.locfileid: "31883456"
---
# <a name="get-started-on-connected-environment-with-nodejs"></a>Introdução ao Connected Environment com Node.js

Etapa anterior: [Saiba mais sobre o desenvolvimento em equipe](get-started-nodejs-06.md)
